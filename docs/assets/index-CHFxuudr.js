...
`].filter(Li).join(`
`)),a=Ma(a),a=Jo(a,t),a=Qo(a,t),o=Ma(o),o=Jo(o,t),o=Qo(o,t),a=jo(a),o=jo(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`)+`
`+u);const R=T+p+a,S=T+u+o,A=Ko(s,s.VERTEX_SHADER,R),b=Ko(s,s.FRAGMENT_SHADER,S);s.attachShader(M,A),s.attachShader(M,b),t.index0AttributeName!==void 0?s.bindAttribLocation(M,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function w(C){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(M)||"",H=s.getShaderInfoLog(A)||"",Y=s.getShaderInfoLog(b)||"",O=N.trim(),X=H.trim(),G=Y.trim();let Q=!0,ee=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(Q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,A,b);else{const se=$o(s,A,"vertex"),K=$o(s,b,"fragment");He("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
...
Program Info Log: `+O+`
`+se+`
`+K)}else O!==""?Re("WebGLProgram: Program Info Log:",O):(X===""||G==="")&&(ee=!1);ee&&(C.diagnostics={runnable:Q,programLog:O,vertexShader:{log:X,prefix:p},fragmentShader:{log:G,prefix:u}})}s.deleteShader(A),s.deleteShader(b),x=new Rs(s,M),E=Fp(s,M)}let x;this.getUniforms=function(){return x===void 0&&w(this),x};let E;this.getAttributes=function(){return E===void 0&&w(this),E};let P=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=s.getProgramParameter(M,Ap)),P},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(M),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Rp++,this.cacheKey=e,this.usedTimes=1,this.program=M,this.vertexShader=A,this.fragmentShader=b,this}let Qp=0;class jp{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e,t,n){const s=this._getShaderCacheForMaterial(e);return s.has(t)===!1&&(s.add(t),t.usedTimes++),s.has(n)===!1&&(s.add(n),n.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderStage(e){return this._getShaderStage(e.vertexShader)}getFragmentShaderStage(e){return this._getShaderStage(e.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new em(e),t.set(e,n)),n}}class em{constructor(e){this.id=Qp++,this.code=e,this.usedTimes=0}}function tm(i){return i===qn||i===ws||i===Cs}function nm(i,e,t,n,s,r){const a=new Rl,o=new jp,c=new Set,l=[],d=new Map,f=n.logarithmicDepthBuffer;let h=n.precision;const m={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function _(x){return c.add(x),x===0?"uv":`uv${x}`}function M(x,E,P,C,N,H){const Y=C.fog,O=N.geometry,X=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?C.environment:null,G=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,Q=e.get(x.envMap||X,G),ee=Q&&Q.mapping===Fs?Q.image.height:null,se=m[x.type];x.precision!==null&&(h=n.getMaxPrecision(x.precision),h!==x.precision&&Re("WebGLProgram.getParameters:",x.precision,"not supported, using",h,"instead."));const K=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,ne=K!==void 0?K.length:0;let Ne=0;O.morphAttributes.position!==void 0&&(Ne=1),O.morphAttributes.normal!==void 0&&(Ne=2),O.morphAttributes.color!==void 0&&(Ne=3);let je,We,J,ae;if(se){const xe=tn[se];je=xe.vertexShader,We=xe.fragmentShader}else{je=x.vertexShader,We=x.fragmentShader;const xe=o.getVertexShaderStage(x),rt=o.getFragmentShaderStage(x);o.update(x,xe,rt),J=xe.id,ae=rt.id}const te=i.getRenderTarget(),Ce=i.state.buffers.depth.getReversed(),Le=N.isInstancedMesh===!0,Te=N.isBatchedMesh===!0,lt=!!x.map,Be=!!x.matcap,$e=!!Q,Xe=!!x.aoMap,ke=!!x.lightMap,dt=!!x.bumpMap&&x.wireframe===!1,mt=!!x.normalMap,St=!!x.displacementMap,yt=!!x.emissiveMap,st=!!x.metalnessMap,ut=!!x.roughnessMap,D=x.anisotropy>0,Lt=x.clearcoat>0,qe=x.dispersion>0,y=x.iridescence>0,g=x.sheen>0,F=x.transmission>0,k=D&&!!x.anisotropyMap,W=Lt&&!!x.clearcoatMap,ie=Lt&&!!x.clearcoatNormalMap,oe=Lt&&!!x.clearcoatRoughnessMap,q=y&&!!x.iridescenceMap,$=y&&!!x.iridescenceThicknessMap,le=g&&!!x.sheenColorMap,Se=g&&!!x.sheenRoughnessMap,de=!!x.specularMap,ce=!!x.specularColorMap,be=!!x.specularIntensityMap,Ae=F&&!!x.transmissionMap,De=F&&!!x.thicknessMap,L=!!x.gradientMap,re=!!x.alphaMap,Z=x.alphaTest>0,he=!!x.alphaHash,me=!!x.extensions;let j=rn;x.toneMapped&&(te===null||te.isXRRenderTarget===!0)&&(j=i.toneMapping);const Me={shaderID:se,shaderType:x.type,shaderName:x.name,vertexShader:je,fragmentShader:We,defines:x.defines,customVertexShaderID:J,customFragmentShaderID:ae,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:h,batching:Te,batchingColor:Te&&N._colorsTexture!==null,instancing:Le,instancingColor:Le&&N.instanceColor!==null,instancingMorph:Le&&N.morphTexture!==null,outputColorSpace:te===null?i.outputColorSpace:te.isXRRenderTarget===!0?te.texture.colorSpace:ze.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:lt,matcap:Be,envMap:$e,envMapMode:$e&&Q.mapping,envMapCubeUVHeight:ee,aoMap:Xe,lightMap:ke,bumpMap:dt,normalMap:mt,displacementMap:St,emissiveMap:yt,normalMapObjectSpace:mt&&x.normalMapType===Ic,normalMapTangentSpace:mt&&x.normalMapType===eo,packedNormalMap:mt&&x.normalMapType===eo&&tm(x.normalMap.format),metalnessMap:st,roughnessMap:ut,anisotropy:D,anisotropyMap:k,clearcoat:Lt,clearcoatMap:W,clearcoatNormalMap:ie,clearcoatRoughnessMap:oe,dispersion:qe,iridescence:y,iridescenceMap:q,iridescenceThicknessMap:$,sheen:g,sheenColorMap:le,sheenRoughnessMap:Se,specularMap:de,specularColorMap:ce,specularIntensityMap:be,transmission:F,transmissionMap:Ae,thicknessMap:De,gradientMap:L,opaque:x.transparent===!1&&x.blending===ui&&x.alphaToCoverage===!1,alphaMap:re,alphaTest:Z,alphaHash:he,combine:x.combine,mapUv:lt&&_(x.map.channel),aoMapUv:Xe&&_(x.aoMap.channel),lightMapUv:ke&&_(x.lightMap.channel),bumpMapUv:dt&&_(x.bumpMap.channel),normalMapUv:mt&&_(x.normalMap.channel),displacementMapUv:St&&_(x.displacementMap.channel),emissiveMapUv:yt&&_(x.emissiveMap.channel),metalnessMapUv:st&&_(x.metalnessMap.channel),roughnessMapUv:ut&&_(x.roughnessMap.channel),anisotropyMapUv:k&&_(x.anisotropyMap.channel),clearcoatMapUv:W&&_(x.clearcoatMap.channel),clearcoatNormalMapUv:ie&&_(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:oe&&_(x.clearcoatRoughnessMap.channel),iridescenceMapUv:q&&_(x.iridescenceMap.channel),iridescenceThicknessMapUv:$&&_(x.iridescenceThicknessMap.channel),sheenColorMapUv:le&&_(x.sheenColorMap.channel),sheenRoughnessMapUv:Se&&_(x.sheenRoughnessMap.channel),specularMapUv:de&&_(x.specularMap.channel),specularColorMapUv:ce&&_(x.specularColorMap.channel),specularIntensityMapUv:be&&_(x.specularIntensityMap.channel),transmissionMapUv:Ae&&_(x.transmissionMap.channel),thicknessMapUv:De&&_(x.thicknessMap.channel),alphaMapUv:re&&_(x.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(mt||D),vertexNormals:!!O.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,pointsUvs:N.isPoints===!0&&!!O.attributes.uv&&(lt||re),fog:!!Y,useFog:x.fog===!0,fogExp2:!!Y&&Y.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||O.attributes.normal===void 0&&mt===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:f,reversedDepthBuffer:Ce,skinning:N.isSkinnedMesh===!0,hasPositionAttribute:O.attributes.position!==void 0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:ne,morphTextureStride:Ne,numDirLights:E.directional.length,numPointLights:E.point.length,numSpotLights:E.spot.length,numSpotLightMaps:E.spotLightMap.length,numRectAreaLights:E.rectArea.length,numHemiLights:E.hemi.length,numDirLightShadows:E.directionalShadowMap.length,numPointLightShadows:E.pointShadowMap.length,numSpotLightShadows:E.spotShadowMap.length,numSpotLightShadowsWithMaps:E.numSpotLightShadowsWithMaps,numLightProbes:E.numLightProbes,numLightProbeGrids:H.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:j,decodeVideoTexture:lt&&x.map.isVideoTexture===!0&&ze.getTransfer(x.map.colorSpace)===Ye,decodeVideoTextureEmissive:yt&&x.emissiveMap.isVideoTexture===!0&&ze.getTransfer(x.emissiveMap.colorSpace)===Ye,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===pn,flipSided:x.side===Ut,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:me&&x.extensions.clipCullDistance===!0&&t.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(me&&x.extensions.multiDraw===!0||Te)&&t.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:t.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return Me.vertexUv1s=c.has(1),Me.vertexUv2s=c.has(2),Me.vertexUv3s=c.has(3),c.clear(),Me}function p(x){const E=[];if(x.shaderID?E.push(x.shaderID):(E.push(x.customVertexShaderID),E.push(x.customFragmentShaderID)),x.defines!==void 0)for(const P in x.defines)E.push(P),E.push(x.defines[P]);return x.isRawShaderMaterial===!1&&(u(E,x),T(E,x),E.push(i.outputColorSpace)),E.push(x.customProgramCacheKey),E.join()}function u(x,E){x.push(E.precision),x.push(E.outputColorSpace),x.push(E.envMapMode),x.push(E.envMapCubeUVHeight),x.push(E.mapUv),x.push(E.alphaMapUv),x.push(E.lightMapUv),x.push(E.aoMapUv),x.push(E.bumpMapUv),x.push(E.normalMapUv),x.push(E.displacementMapUv),x.push(E.emissiveMapUv),x.push(E.metalnessMapUv),x.push(E.roughnessMapUv),x.push(E.anisotropyMapUv),x.push(E.clearcoatMapUv),x.push(E.clearcoatNormalMapUv),x.push(E.clearcoatRoughnessMapUv),x.push(E.iridescenceMapUv),x.push(E.iridescenceThicknessMapUv),x.push(E.sheenColorMapUv),x.push(E.sheenRoughnessMapUv),x.push(E.specularMapUv),x.push(E.specularColorMapUv),x.push(E.specularIntensityMapUv),x.push(E.transmissionMapUv),x.push(E.thicknessMapUv),x.push(E.combine),x.push(E.fogExp2),x.push(E.sizeAttenuation),x.push(E.morphTargetsCount),x.push(E.morphAttributeCount),x.push(E.numDirLights),x.push(E.numPointLights),x.push(E.numSpotLights),x.push(E.numSpotLightMaps),x.push(E.numHemiLights),x.push(E.numRectAreaLights),x.push(E.numDirLightShadows),x.push(E.numPointLightShadows),x.push(E.numSpotLightShadows),x.push(E.numSpotLightShadowsWithMaps),x.push(E.numLightProbes),x.push(E.shadowMapType),x.push(E.toneMapping),x.push(E.numClippingPlanes),x.push(E.numClipIntersection),x.push(E.depthPacking)}function T(x,E){a.disableAll(),E.instancing&&a.enable(0),E.instancingColor&&a.enable(1),E.instancingMorph&&a.enable(2),E.matcap&&a.enable(3),E.envMap&&a.enable(4),E.normalMapObjectSpace&&a.enable(5),E.normalMapTangentSpace&&a.enable(6),E.clearcoat&&a.enable(7),E.iridescence&&a.enable(8),E.alphaTest&&a.enable(9),E.vertexColors&&a.enable(10),E.vertexAlphas&&a.enable(11),E.vertexUv1s&&a.enable(12),E.vertexUv2s&&a.enable(13),E.vertexUv3s&&a.enable(14),E.vertexTangents&&a.enable(15),E.anisotropy&&a.enable(16),E.alphaHash&&a.enable(17),E.batching&&a.enable(18),E.dispersion&&a.enable(19),E.batchingColor&&a.enable(20),E.gradientMap&&a.enable(21),E.packedNormalMap&&a.enable(22),E.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),E.fog&&a.enable(0),E.useFog&&a.enable(1),E.flatShading&&a.enable(2),E.logarithmicDepthBuffer&&a.enable(3),E.reversedDepthBuffer&&a.enable(4),E.skinning&&a.enable(5),E.morphTargets&&a.enable(6),E.morphNormals&&a.enable(7),E.morphColors&&a.enable(8),E.premultipliedAlpha&&a.enable(9),E.shadowMapEnabled&&a.enable(10),E.doubleSided&&a.enable(11),E.flipSided&&a.enable(12),E.useDepthPacking&&a.enable(13),E.dithering&&a.enable(14),E.transmission&&a.enable(15),E.sheen&&a.enable(16),E.opaque&&a.enable(17),E.pointsUvs&&a.enable(18),E.decodeVideoTexture&&a.enable(19),E.decodeVideoTextureEmissive&&a.enable(20),E.alphaToCoverage&&a.enable(21),E.numLightProbeGrids>0&&a.enable(22),E.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function R(x){const E=m[x.type];let P;if(E){const C=tn[E];P=vh.clone(C.uniforms)}else P=x.uniforms;return P}function S(x,E){let P=d.get(E);return P!==void 0?++P.usedTimes:(P=new Jp(i,E,x,s),l.push(P),d.set(E,P)),P}function A(x){if(--x.usedTimes===0){const E=l.indexOf(x);l[E]=l[l.length-1],l.pop(),d.delete(x.cacheKey),x.destroy()}}function b(x){o.remove(x)}function w(){o.dispose()}return{getParameters:M,getProgramCacheKey:p,getUniforms:R,acquireProgram:S,releaseProgram:A,releaseShaderCache:b,programs:l,dispose:w}}function im(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,c){i.get(a)[o]=c}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function sm(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.materialVariant!==e.materialVariant?i.materialVariant-e.materialVariant:i.z!==e.z?i.z-e.z:i.id-e.id}function tl(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function nl(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h){let m=0;return h.isInstancedMesh&&(m+=2),h.isSkinnedMesh&&(m+=1),m}function o(h,m,_,M,p,u){let T=i[e];return T===void 0?(T={id:h.id,object:h,geometry:m,material:_,materialVariant:a(h),groupOrder:M,renderOrder:h.renderOrder,z:p,group:u},i[e]=T):(T.id=h.id,T.object=h,T.geometry=m,T.material=_,T.materialVariant=a(h),T.groupOrder=M,T.renderOrder=h.renderOrder,T.z=p,T.group=u),e++,T}function c(h,m,_,M,p,u){const T=o(h,m,_,M,p,u);_.transmission>0?n.push(T):_.transparent===!0?s.push(T):t.push(T)}function l(h,m,_,M,p,u){const T=o(h,m,_,M,p,u);_.transmission>0?n.unshift(T):_.transparent===!0?s.unshift(T):t.unshift(T)}function d(h,m,_){t.length>1&&t.sort(h||sm),n.length>1&&n.sort(m||tl),s.length>1&&s.sort(m||tl),_&&(t.reverse(),n.reverse(),s.reverse())}function f(){for(let h=e,m=i.length;h<m;h++){const _=i[h];if(_.id===null)break;_.id=null,_.object=null,_.geometry=null,_.material=null,_.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:c,unshift:l,finish:f,sort:d}}function rm(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new nl,i.set(n,[a])):s>=r.length?(a=new nl,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function am(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new I,color:new Ge};break;case"SpotLight":t={position:new I,direction:new I,color:new Ge,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new I,color:new Ge,distance:0,decay:0};break;case"HemisphereLight":t={direction:new I,skyColor:new Ge,groundColor:new Ge};break;case"RectAreaLight":t={color:new Ge,position:new I,halfWidth:new I,halfHeight:new I};break}return i[e.id]=t,t}}}function om(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new we};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new we};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new we,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let lm=0;function cm(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function hm(i){const e=new am,t=om(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)n.probe.push(new I);const s=new I,r=new nt,a=new nt;function o(l){let d=0,f=0,h=0;for(let E=0;E<9;E++)n.probe[E].set(0,0,0);let m=0,_=0,M=0,p=0,u=0,T=0,R=0,S=0,A=0,b=0,w=0;l.sort(cm);for(let E=0,P=l.length;E<P;E++){const C=l[E],N=C.color,H=C.intensity,Y=C.distance;let O=null;if(C.shadow&&C.shadow.map&&(C.shadow.map.texture.format===qn?O=C.shadow.map.texture:O=C.shadow.map.depthTexture||C.shadow.map.texture),C.isAmbientLight)d+=N.r*H,f+=N.g*H,h+=N.b*H;else if(C.isLightProbe){for(let X=0;X<9;X++)n.probe[X].addScaledVector(C.sh.coefficients[X],H);w++}else if(C.isDirectionalLight){const X=e.get(C);if(X.color.copy(C.color).multiplyScalar(C.intensity),C.castShadow){const G=C.shadow,Q=t.get(C);Q.shadowIntensity=G.intensity,Q.shadowBias=G.bias,Q.shadowNormalBias=G.normalBias,Q.shadowRadius=G.radius,Q.shadowMapSize=G.mapSize,n.directionalShadow[m]=Q,n.directionalShadowMap[m]=O,n.directionalShadowMatrix[m]=C.shadow.matrix,T++}n.directional[m]=X,m++}else if(C.isSpotLight){const X=e.get(C);X.position.setFromMatrixPosition(C.matrixWorld),X.color.copy(N).multiplyScalar(H),X.distance=Y,X.coneCos=Math.cos(C.angle),X.penumbraCos=Math.cos(C.angle*(1-C.penumbra)),X.decay=C.decay,n.spot[M]=X;const G=C.shadow;if(C.map&&(n.spotLightMap[A]=C.map,A++,G.updateMatrices(C),C.castShadow&&b++),n.spotLightMatrix[M]=G.matrix,C.castShadow){const Q=t.get(C);Q.shadowIntensity=G.intensity,Q.shadowBias=G.bias,Q.shadowNormalBias=G.normalBias,Q.shadowRadius=G.radius,Q.shadowMapSize=G.mapSize,n.spotShadow[M]=Q,n.spotShadowMap[M]=O,S++}M++}else if(C.isRectAreaLight){const X=e.get(C);X.color.copy(N).multiplyScalar(H),X.halfWidth.set(C.width*.5,0,0),X.halfHeight.set(0,C.height*.5,0),n.rectArea[p]=X,p++}else if(C.isPointLight){const X=e.get(C);if(X.color.copy(C.color).multiplyScalar(C.intensity),X.distance=C.distance,X.decay=C.decay,C.castShadow){const G=C.shadow,Q=t.get(C);Q.shadowIntensity=G.intensity,Q.shadowBias=G.bias,Q.shadowNormalBias=G.normalBias,Q.shadowRadius=G.radius,Q.shadowMapSize=G.mapSize,Q.shadowCameraNear=G.camera.near,Q.shadowCameraFar=G.camera.far,n.pointShadow[_]=Q,n.pointShadowMap[_]=O,n.pointShadowMatrix[_]=C.shadow.matrix,R++}n.point[_]=X,_++}else if(C.isHemisphereLight){const X=e.get(C);X.skyColor.copy(C.color).multiplyScalar(H),X.groundColor.copy(C.groundColor).multiplyScalar(H),n.hemi[u]=X,u++}}p>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=ue.LTC_FLOAT_1,n.rectAreaLTC2=ue.LTC_FLOAT_2):(n.rectAreaLTC1=ue.LTC_HALF_1,n.rectAreaLTC2=ue.LTC_HALF_2)),n.ambient[0]=d,n.ambient[1]=f,n.ambient[2]=h;const x=n.hash;(x.directionalLength!==m||x.pointLength!==_||x.spotLength!==M||x.rectAreaLength!==p||x.hemiLength!==u||x.numDirectionalShadows!==T||x.numPointShadows!==R||x.numSpotShadows!==S||x.numSpotMaps!==A||x.numLightProbes!==w)&&(n.directional.length=m,n.spot.length=M,n.rectArea.length=p,n.point.length=_,n.hemi.length=u,n.directionalShadow.length=T,n.directionalShadowMap.length=T,n.pointShadow.length=R,n.pointShadowMap.length=R,n.spotShadow.length=S,n.spotShadowMap.length=S,n.directionalShadowMatrix.length=T,n.pointShadowMatrix.length=R,n.spotLightMatrix.length=S+A-b,n.spotLightMap.length=A,n.numSpotLightShadowsWithMaps=b,n.numLightProbes=w,x.directionalLength=m,x.pointLength=_,x.spotLength=M,x.rectAreaLength=p,x.hemiLength=u,x.numDirectionalShadows=T,x.numPointShadows=R,x.numSpotShadows=S,x.numSpotMaps=A,x.numLightProbes=w,n.version=lm++)}function c(l,d){let f=0,h=0,m=0,_=0,M=0;const p=d.matrixWorldInverse;for(let u=0,T=l.length;u<T;u++){const R=l[u];if(R.isDirectionalLight){const S=n.directional[f];S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),f++}else if(R.isSpotLight){const S=n.spot[m];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),S.direction.setFromMatrixPosition(R.matrixWorld),s.setFromMatrixPosition(R.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(p),m++}else if(R.isRectAreaLight){const S=n.rectArea[_];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),a.identity(),r.copy(R.matrixWorld),r.premultiply(p),a.extractRotation(r),S.halfWidth.set(R.width*.5,0,0),S.halfHeight.set(0,R.height*.5,0),S.halfWidth.applyMatrix4(a),S.halfHeight.applyMatrix4(a),_++}else if(R.isPointLight){const S=n.point[h];S.position.setFromMatrixPosition(R.matrixWorld),S.position.applyMatrix4(p),h++}else if(R.isHemisphereLight){const S=n.hemi[M];S.direction.setFromMatrixPosition(R.matrixWorld),S.direction.transformDirection(p),M++}}}return{setup:o,setupView:c,state:n}}function il(i){const e=new hm(i),t=[],n=[],s=[];function r(h){f.camera=h,t.length=0,n.length=0,s.length=0}function a(h){t.push(h)}function o(h){n.push(h)}function c(h){s.push(h)}function l(){e.setup(t)}function d(h){e.setupView(t,h)}const f={lightsArray:t,shadowsArray:n,lightProbeGridArray:s,camera:null,lights:e,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:f,setupLights:l,setupLightsView:d,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function dm(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new il(i),e.set(s,[o])):r>=a.length?(o=new il(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const um=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,pm=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],mm=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],sl=new nt,Ci=new I,Tr=new I;function gm(i,e,t){let n=new La;const s=new we,r=new we,a=new it,o=new yh,c=new bh,l={},d=t.maxTextureSize,f={[Dn]:Ut,[Ut]:Dn,[pn]:pn},h=new Zt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new we},radius:{value:4}},vertexShader:um,fragmentShader:fm}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const _=new _t;_.setAttribute("position",new on(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const M=new Wt(_,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Es;let u=this.type;this.render=function(b,w,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;this.type===hc&&(Re("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Es);const E=i.getRenderTarget(),P=i.getActiveCubeFace(),C=i.getActiveMipmapLevel(),N=i.state;N.setBlending(gn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const H=u!==this.type;H&&w.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(O=>O.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,O=b.length;Y<O;Y++){const X=b[Y],G=X.shadow;if(G===void 0){Re("WebGLShadowMap:",X,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;s.copy(G.mapSize);const Q=G.getFrameExtents();s.multiply(Q),r.copy(G.mapSize),(s.x>d||s.y>d)&&(s.x>d&&(r.x=Math.floor(d/Q.x),s.x=r.x*Q.x,G.mapSize.x=r.x),s.y>d&&(r.y=Math.floor(d/Q.y),s.y=r.y*Q.y,G.mapSize.y=r.y));const ee=i.state.buffers.depth.getReversed();if(G.camera._reversedDepth=ee,G.map===null||H===!0){if(G.map!==null&&(G.map.depthTexture!==null&&(G.map.depthTexture.dispose(),G.map.depthTexture=null),G.map.dispose()),this.type===Pi){if(X.isPointLight){Re("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}G.map=new an(s.x,s.y,{format:qn,type:xn,minFilter:wt,magFilter:wt,generateMipmaps:!1}),G.map.texture.name=X.name+".shadowMap",G.map.depthTexture=new _i(s.x,s.y,nn),G.map.depthTexture.name=X.name+".shadowMapDepth",G.map.depthTexture.format=vn,G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt}else X.isPointLight?(G.map=new Gl(s.x),G.map.depthTexture=new gh(s.x,ln)):(G.map=new an(s.x,s.y),G.map.depthTexture=new _i(s.x,s.y,ln)),G.map.depthTexture.name=X.name+".shadowMap",G.map.depthTexture.format=vn,this.type===Es?(G.map.depthTexture.compareFunction=ee?Ca:wa,G.map.depthTexture.minFilter=wt,G.map.depthTexture.magFilter=wt):(G.map.depthTexture.compareFunction=null,G.map.depthTexture.minFilter=bt,G.map.depthTexture.magFilter=bt);G.camera.updateProjectionMatrix()}const se=G.map.isWebGLCubeRenderTarget?6:1;for(let K=0;K<se;K++){if(G.map.isWebGLCubeRenderTarget)i.setRenderTarget(G.map,K),i.clear();else{K===0&&(i.setRenderTarget(G.map),i.clear());const ne=G.getViewport(K);a.set(r.x*ne.x,r.y*ne.y,r.x*ne.z,r.y*ne.w),N.viewport(a)}if(X.isPointLight){const ne=G.camera,Ne=G.matrix,je=X.distance||ne.far;je!==ne.far&&(ne.far=je,ne.updateProjectionMatrix()),Ci.setFromMatrixPosition(X.matrixWorld),ne.position.copy(Ci),Tr.copy(ne.position),Tr.add(pm[K]),ne.up.copy(mm[K]),ne.lookAt(Tr),ne.updateMatrixWorld(),Ne.makeTranslation(-Ci.x,-Ci.y,-Ci.z),sl.multiplyMatrices(ne.projectionMatrix,ne.matrixWorldInverse),G._frustum.setFromProjectionMatrix(sl,ne.coordinateSystem,ne.reversedDepth)}else G.updateMatrices(X);n=G.getFrustum(),S(w,x,G.camera,X,this.type)}G.isPointLightShadow!==!0&&this.type===Pi&&T(G,x),G.needsUpdate=!1}u=this.type,p.needsUpdate=!1,i.setRenderTarget(E,P,C)};function T(b,w){const x=e.update(M);h.defines.VSM_SAMPLES!==b.blurSamples&&(h.defines.VSM_SAMPLES=b.blurSamples,m.defines.VSM_SAMPLES=b.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new an(s.x,s.y,{format:qn,type:xn})),h.uniforms.shadow_pass.value=b.map.depthTexture,h.uniforms.resolution.value=b.mapSize,h.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(w,null,x,h,M,null),m.uniforms.shadow_pass.value=b.mapPass.texture,m.uniforms.resolution.value=b.mapSize,m.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(w,null,x,m,M,null)}function R(b,w,x,E){let P=null;const C=x.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(C!==void 0)P=C;else if(P=x.isPointLight===!0?c:o,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const N=P.uuid,H=w.uuid;let Y=l[N];Y===void 0&&(Y={},l[N]=Y);let O=Y[H];O===void 0&&(O=P.clone(),Y[H]=O,w.addEventListener("dispose",A)),P=O}if(P.visible=w.visible,P.wireframe=w.wireframe,E===Pi?P.side=w.shadowSide!==null?w.shadowSide:w.side:P.side=w.shadowSide!==null?w.shadowSide:f[w.side],P.alphaMap=w.alphaMap,P.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,P.map=w.map,P.clipShadows=w.clipShadows,P.clippingPlanes=w.clippingPlanes,P.clipIntersection=w.clipIntersection,P.displacementMap=w.displacementMap,P.displacementScale=w.displacementScale,P.displacementBias=w.displacementBias,P.wireframeLinewidth=w.wireframeLinewidth,P.linewidth=w.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const N=i.properties.get(P);N.light=x}return P}function S(b,w,x,E,P){if(b.visible===!1)return;if(b.layers.test(w.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&P===Pi)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,b.matrixWorld);const H=e.update(b),Y=b.material;if(Array.isArray(Y)){const O=H.groups;for(let X=0,G=O.length;X<G;X++){const Q=O[X],ee=Y[Q.materialIndex];if(ee&&ee.visible){const se=R(b,ee,E,P);b.onBeforeShadow(i,b,w,x,H,se,Q),i.renderBufferDirect(x,null,H,se,b,Q),b.onAfterShadow(i,b,w,x,H,se,Q)}}}else if(Y.visible){const O=R(b,Y,E,P);b.onBeforeShadow(i,b,w,x,H,O,null),i.renderBufferDirect(x,null,H,O,b,null),b.onAfterShadow(i,b,w,x,H,O,null)}}const N=b.children;for(let H=0,Y=N.length;H<Y;H++)S(N[H],w,x,E,P)}function A(b){b.target.removeEventListener("dispose",A);for(const x in l){const E=l[x],P=b.target.uuid;P in E&&(E[P].dispose(),delete E[P])}}}function _m(i,e){function t(){let L=!1;const re=new it;let Z=null;const he=new it(0,0,0,0);return{setMask:function(me){Z!==me&&!L&&(i.colorMask(me,me,me,me),Z=me)},setLocked:function(me){L=me},setClear:function(me,j,Me,xe,rt){rt===!0&&(me*=xe,j*=xe,Me*=xe),re.set(me,j,Me,xe),he.equals(re)===!1&&(i.clearColor(me,j,Me,xe),he.copy(re))},reset:function(){L=!1,Z=null,he.set(-1,0,0,0)}}}function n(){let L=!1,re=!1,Z=null,he=null,me=null;return{setReversed:function(j){if(re!==j){const Me=e.get("EXT_clip_control");j?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),re=j;const xe=me;me=null,this.setClear(xe)}},getReversed:function(){return re},setTest:function(j){j?te(i.DEPTH_TEST):Ce(i.DEPTH_TEST)},setMask:function(j){Z!==j&&!L&&(i.depthMask(j),Z=j)},setFunc:function(j){if(re&&(j=Hc[j]),he!==j){switch(j){case Dr:i.depthFunc(i.NEVER);break;case Ir:i.depthFunc(i.ALWAYS);break;case Ur:i.depthFunc(i.LESS);break;case mi:i.depthFunc(i.LEQUAL);break;case Nr:i.depthFunc(i.EQUAL);break;case Fr:i.depthFunc(i.GEQUAL);break;case Or:i.depthFunc(i.GREATER);break;case Br:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}he=j}},setLocked:function(j){L=j},setClear:function(j){me!==j&&(me=j,re&&(j=1-j),i.clearDepth(j))},reset:function(){L=!1,Z=null,he=null,me=null,re=!1}}}function s(){let L=!1,re=null,Z=null,he=null,me=null,j=null,Me=null,xe=null,rt=null;return{setTest:function(et){L||(et?te(i.STENCIL_TEST):Ce(i.STENCIL_TEST))},setMask:function(et){re!==et&&!L&&(i.stencilMask(et),re=et)},setFunc:function(et,$t,Jt){(Z!==et||he!==$t||me!==Jt)&&(i.stencilFunc(et,$t,Jt),Z=et,he=$t,me=Jt)},setOp:function(et,$t,Jt){(j!==et||Me!==$t||xe!==Jt)&&(i.stencilOp(et,$t,Jt),j=et,Me=$t,xe=Jt)},setLocked:function(et){L=et},setClear:function(et){rt!==et&&(i.clearStencil(et),rt=et)},reset:function(){L=!1,re=null,Z=null,he=null,me=null,j=null,Me=null,xe=null,rt=null}}}const r=new t,a=new n,o=new s,c=new WeakMap,l=new WeakMap;let d={},f={},h={},m=new WeakMap,_=[],M=null,p=!1,u=null,T=null,R=null,S=null,A=null,b=null,w=null,x=new Ge(0,0,0),E=0,P=!1,C=null,N=null,H=null,Y=null,O=null;const X=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,Q=0;const ee=i.getParameter(i.VERSION);ee.indexOf("WebGL")!==-1?(Q=parseFloat(/^WebGL (\d)/.exec(ee)[1]),G=Q>=1):ee.indexOf("OpenGL ES")!==-1&&(Q=parseFloat(/^OpenGL ES (\d)/.exec(ee)[1]),G=Q>=2);let se=null,K={};const ne=i.getParameter(i.SCISSOR_BOX),Ne=i.getParameter(i.VIEWPORT),je=new it().fromArray(ne),We=new it().fromArray(Ne);function J(L,re,Z,he){const me=new Uint8Array(4),j=i.createTexture();i.bindTexture(L,j),i.texParameteri(L,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(L,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Me=0;Me<Z;Me++)L===i.TEXTURE_3D||L===i.TEXTURE_2D_ARRAY?i.texImage3D(re,0,i.RGBA,1,1,he,0,i.RGBA,i.UNSIGNED_BYTE,me):i.texImage2D(re+Me,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,me);return j}const ae={};ae[i.TEXTURE_2D]=J(i.TEXTURE_2D,i.TEXTURE_2D,1),ae[i.TEXTURE_CUBE_MAP]=J(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[i.TEXTURE_2D_ARRAY]=J(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ae[i.TEXTURE_3D]=J(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),te(i.DEPTH_TEST),a.setFunc(mi),dt(!1),mt(Ja),te(i.CULL_FACE),Xe(gn);function te(L){d[L]!==!0&&(i.enable(L),d[L]=!0)}function Ce(L){d[L]!==!1&&(i.disable(L),d[L]=!1)}function Le(L,re){return h[L]!==re?(i.bindFramebuffer(L,re),h[L]=re,L===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=re),L===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=re),!0):!1}function Te(L,re){let Z=_,he=!1;if(L){Z=m.get(re),Z===void 0&&(Z=[],m.set(re,Z));const me=L.textures;if(Z.length!==me.length||Z[0]!==i.COLOR_ATTACHMENT0){for(let j=0,Me=me.length;j<Me;j++)Z[j]=i.COLOR_ATTACHMENT0+j;Z.length=me.length,he=!0}}else Z[0]!==i.BACK&&(Z[0]=i.BACK,he=!0);he&&i.drawBuffers(Z)}function lt(L){return M!==L?(i.useProgram(L),M=L,!0):!1}const Be={[Gn]:i.FUNC_ADD,[uc]:i.FUNC_SUBTRACT,[fc]:i.FUNC_REVERSE_SUBTRACT};Be[pc]=i.MIN,Be[mc]=i.MAX;const $e={[gc]:i.ZERO,[_c]:i.ONE,[xc]:i.SRC_COLOR,[Pr]:i.SRC_ALPHA,[bc]:i.SRC_ALPHA_SATURATE,[Ec]:i.DST_COLOR,[Mc]:i.DST_ALPHA,[vc]:i.ONE_MINUS_SRC_COLOR,[Lr]:i.ONE_MINUS_SRC_ALPHA,[yc]:i.ONE_MINUS_DST_COLOR,[Sc]:i.ONE_MINUS_DST_ALPHA,[Tc]:i.CONSTANT_COLOR,[Ac]:i.ONE_MINUS_CONSTANT_COLOR,[Rc]:i.CONSTANT_ALPHA,[wc]:i.ONE_MINUS_CONSTANT_ALPHA};function Xe(L,re,Z,he,me,j,Me,xe,rt,et){if(L===gn){p===!0&&(Ce(i.BLEND),p=!1);return}if(p===!1&&(te(i.BLEND),p=!0),L!==dc){if(L!==u||et!==P){if((T!==Gn||A!==Gn)&&(i.blendEquation(i.FUNC_ADD),T=Gn,A=Gn),et)switch(L){case ui:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Cr:i.blendFunc(i.ONE,i.ONE);break;case Qa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case ja:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:He("WebGLState: Invalid blending: ",L);break}else switch(L){case ui:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Cr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Qa:He("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ja:He("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:He("WebGLState: Invalid blending: ",L);break}R=null,S=null,b=null,w=null,x.set(0,0,0),E=0,u=L,P=et}return}me=me||re,j=j||Z,Me=Me||he,(re!==T||me!==A)&&(i.blendEquationSeparate(Be[re],Be[me]),T=re,A=me),(Z!==R||he!==S||j!==b||Me!==w)&&(i.blendFuncSeparate($e[Z],$e[he],$e[j],$e[Me]),R=Z,S=he,b=j,w=Me),(xe.equals(x)===!1||rt!==E)&&(i.blendColor(xe.r,xe.g,xe.b,rt),x.copy(xe),E=rt),u=L,P=!1}function ke(L,re){L.side===pn?Ce(i.CULL_FACE):te(i.CULL_FACE);let Z=L.side===Ut;re&&(Z=!Z),dt(Z),L.blending===ui&&L.transparent===!1?Xe(gn):Xe(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),r.setMask(L.colorWrite);const he=L.stencilWrite;o.setTest(he),he&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),yt(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):Ce(i.SAMPLE_ALPHA_TO_COVERAGE)}function dt(L){C!==L&&(L?i.frontFace(i.CW):i.frontFace(i.CCW),C=L)}function mt(L){L!==lc?(te(i.CULL_FACE),L!==N&&(L===Ja?i.cullFace(i.BACK):L===cc?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Ce(i.CULL_FACE),N=L}function St(L){L!==H&&(G&&i.lineWidth(L),H=L)}function yt(L,re,Z){L?(te(i.POLYGON_OFFSET_FILL),(Y!==re||O!==Z)&&(Y=re,O=Z,a.getReversed()&&(re=-re),i.polygonOffset(re,Z))):Ce(i.POLYGON_OFFSET_FILL)}function st(L){L?te(i.SCISSOR_TEST):Ce(i.SCISSOR_TEST)}function ut(L){L===void 0&&(L=i.TEXTURE0+X-1),se!==L&&(i.activeTexture(L),se=L)}function D(L,re,Z){Z===void 0&&(se===null?Z=i.TEXTURE0+X-1:Z=se);let he=K[Z];he===void 0&&(he={type:void 0,texture:void 0},K[Z]=he),(he.type!==L||he.texture!==re)&&(se!==Z&&(i.activeTexture(Z),se=Z),i.bindTexture(L,re||ae[L]),he.type=L,he.texture=re)}function Lt(){const L=K[se];L!==void 0&&L.type!==void 0&&(i.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function qe(){try{i.compressedTexImage2D(...arguments)}catch(L){He("WebGLState:",L)}}function y(){try{i.compressedTexImage3D(...arguments)}catch(L){He("WebGLState:",L)}}function g(){try{i.texSubImage2D(...arguments)}catch(L){He("WebGLState:",L)}}function F(){try{i.texSubImage3D(...arguments)}catch(L){He("WebGLState:",L)}}function k(){try{i.compressedTexSubImage2D(...arguments)}catch(L){He("WebGLState:",L)}}function W(){try{i.compressedTexSubImage3D(...arguments)}catch(L){He("WebGLState:",L)}}function ie(){try{i.texStorage2D(...arguments)}catch(L){He("WebGLState:",L)}}function oe(){try{i.texStorage3D(...arguments)}catch(L){He("WebGLState:",L)}}function q(){try{i.texImage2D(...arguments)}catch(L){He("WebGLState:",L)}}function $(){try{i.texImage3D(...arguments)}catch(L){He("WebGLState:",L)}}function le(L){return f[L]!==void 0?f[L]:i.getParameter(L)}function Se(L,re){f[L]!==re&&(i.pixelStorei(L,re),f[L]=re)}function de(L){je.equals(L)===!1&&(i.scissor(L.x,L.y,L.z,L.w),je.copy(L))}function ce(L){We.equals(L)===!1&&(i.viewport(L.x,L.y,L.z,L.w),We.copy(L))}function be(L,re){let Z=l.get(re);Z===void 0&&(Z=new WeakMap,l.set(re,Z));let he=Z.get(L);he===void 0&&(he=i.getUniformBlockIndex(re,L.name),Z.set(L,he))}function Ae(L,re){const he=l.get(re).get(L);c.get(re)!==he&&(i.uniformBlockBinding(re,he,L.__bindingPointIndex),c.set(re,he))}function De(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},f={},se=null,K={},h={},m=new WeakMap,_=[],M=null,p=!1,u=null,T=null,R=null,S=null,A=null,b=null,w=null,x=new Ge(0,0,0),E=0,P=!1,C=null,N=null,H=null,Y=null,O=null,je.set(0,0,i.canvas.width,i.canvas.height),We.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:te,disable:Ce,bindFramebuffer:Le,drawBuffers:Te,useProgram:lt,setBlending:Xe,setMaterial:ke,setFlipSided:dt,setCullFace:mt,setLineWidth:St,setPolygonOffset:yt,setScissorTest:st,activeTexture:ut,bindTexture:D,unbindTexture:Lt,compressedTexImage2D:qe,compressedTexImage3D:y,texImage2D:q,texImage3D:$,pixelStorei:Se,getParameter:le,updateUBOMapping:be,uniformBlockBinding:Ae,texStorage2D:ie,texStorage3D:oe,texSubImage2D:g,texSubImage3D:F,compressedTexSubImage2D:k,compressedTexSubImage3D:W,scissor:de,viewport:ce,reset:De}}function xm(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new we,d=new WeakMap,f=new Set;let h;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(y,g){return _?new OffscreenCanvas(y,g):Ds("canvas")}function p(y,g,F){let k=1;const W=qe(y);if((W.width>F||W.height>F)&&(k=F/Math.max(W.width,W.height)),k<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const ie=Math.floor(k*W.width),oe=Math.floor(k*W.height);h===void 0&&(h=M(ie,oe));const q=g?M(ie,oe):h;return q.width=ie,q.height=oe,q.getContext("2d").drawImage(y,0,0,ie,oe),Re("WebGLRenderer: Texture has been resized from ("+W.width+"x"+W.height+") to ("+ie+"x"+oe+")."),q}else return"data"in y&&Re("WebGLRenderer: Image in DataTexture is too big ("+W.width+"x"+W.height+")."),y;return y}function u(y){return y.generateMipmaps}function T(y){i.generateMipmap(y)}function R(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function S(y,g,F,k,W,ie=!1){if(y!==null){if(i[y]!==void 0)return i[y];Re("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let oe;k&&(oe=e.get("EXT_texture_norm16"),oe||Re("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let q=g;if(g===i.RED&&(F===i.FLOAT&&(q=i.R32F),F===i.HALF_FLOAT&&(q=i.R16F),F===i.UNSIGNED_BYTE&&(q=i.R8),F===i.UNSIGNED_SHORT&&oe&&(q=oe.R16_EXT),F===i.SHORT&&oe&&(q=oe.R16_SNORM_EXT)),g===i.RED_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.R8UI),F===i.UNSIGNED_SHORT&&(q=i.R16UI),F===i.UNSIGNED_INT&&(q=i.R32UI),F===i.BYTE&&(q=i.R8I),F===i.SHORT&&(q=i.R16I),F===i.INT&&(q=i.R32I)),g===i.RG&&(F===i.FLOAT&&(q=i.RG32F),F===i.HALF_FLOAT&&(q=i.RG16F),F===i.UNSIGNED_BYTE&&(q=i.RG8),F===i.UNSIGNED_SHORT&&oe&&(q=oe.RG16_EXT),F===i.SHORT&&oe&&(q=oe.RG16_SNORM_EXT)),g===i.RG_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RG8UI),F===i.UNSIGNED_SHORT&&(q=i.RG16UI),F===i.UNSIGNED_INT&&(q=i.RG32UI),F===i.BYTE&&(q=i.RG8I),F===i.SHORT&&(q=i.RG16I),F===i.INT&&(q=i.RG32I)),g===i.RGB_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGB8UI),F===i.UNSIGNED_SHORT&&(q=i.RGB16UI),F===i.UNSIGNED_INT&&(q=i.RGB32UI),F===i.BYTE&&(q=i.RGB8I),F===i.SHORT&&(q=i.RGB16I),F===i.INT&&(q=i.RGB32I)),g===i.RGBA_INTEGER&&(F===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),F===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),F===i.UNSIGNED_INT&&(q=i.RGBA32UI),F===i.BYTE&&(q=i.RGBA8I),F===i.SHORT&&(q=i.RGBA16I),F===i.INT&&(q=i.RGBA32I)),g===i.RGB&&(F===i.UNSIGNED_SHORT&&oe&&(q=oe.RGB16_EXT),F===i.SHORT&&oe&&(q=oe.RGB16_SNORM_EXT),F===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),F===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),g===i.RGBA){const $=ie?Ls:ze.getTransfer(W);F===i.FLOAT&&(q=i.RGBA32F),F===i.HALF_FLOAT&&(q=i.RGBA16F),F===i.UNSIGNED_BYTE&&(q=$===Ye?i.SRGB8_ALPHA8:i.RGBA8),F===i.UNSIGNED_SHORT&&oe&&(q=oe.RGBA16_EXT),F===i.SHORT&&oe&&(q=oe.RGBA16_SNORM_EXT),F===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),F===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function A(y,g){let F;return y?g===null||g===ln||g===Ni?F=i.DEPTH24_STENCIL8:g===nn?F=i.DEPTH32F_STENCIL8:g===Ui&&(F=i.DEPTH24_STENCIL8,Re("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===ln||g===Ni?F=i.DEPTH_COMPONENT24:g===nn?F=i.DEPTH_COMPONENT32F:g===Ui&&(F=i.DEPTH_COMPONENT16),F}function b(y,g){return u(y)===!0||y.isFramebufferTexture&&y.minFilter!==bt&&y.minFilter!==wt?Math.log2(Math.max(g.width,g.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?g.mipmaps.length:1}function w(y){const g=y.target;g.removeEventListener("dispose",w),E(g),g.isVideoTexture&&d.delete(g),g.isHTMLTexture&&f.delete(g)}function x(y){const g=y.target;g.removeEventListener("dispose",x),C(g)}function E(y){const g=n.get(y);if(g.__webglInit===void 0)return;const F=y.source,k=m.get(F);if(k){const W=k[g.__cacheKey];W.usedTimes--,W.usedTimes===0&&P(y),Object.keys(k).length===0&&m.delete(F)}n.remove(y)}function P(y){const g=n.get(y);i.deleteTexture(g.__webglTexture);const F=y.source,k=m.get(F);delete k[g.__cacheKey],a.memory.textures--}function C(y){const g=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let k=0;k<6;k++){if(Array.isArray(g.__webglFramebuffer[k]))for(let W=0;W<g.__webglFramebuffer[k].length;W++)i.deleteFramebuffer(g.__webglFramebuffer[k][W]);else i.deleteFramebuffer(g.__webglFramebuffer[k]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[k])}else{if(Array.isArray(g.__webglFramebuffer))for(let k=0;k<g.__webglFramebuffer.length;k++)i.deleteFramebuffer(g.__webglFramebuffer[k]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let k=0;k<g.__webglColorRenderbuffer.length;k++)g.__webglColorRenderbuffer[k]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[k]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const F=y.textures;for(let k=0,W=F.length;k<W;k++){const ie=n.get(F[k]);ie.__webglTexture&&(i.deleteTexture(ie.__webglTexture),a.memory.textures--),n.remove(F[k])}n.remove(y)}let N=0;function H(){N=0}function Y(){return N}function O(y){N=y}function X(){const y=N;return y>=s.maxTextures&&Re("WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+s.maxTextures),N+=1,y}function G(y){const g=[];return g.push(y.wrapS),g.push(y.wrapT),g.push(y.wrapR||0),g.push(y.magFilter),g.push(y.minFilter),g.push(y.anisotropy),g.push(y.internalFormat),g.push(y.format),g.push(y.type),g.push(y.generateMipmaps),g.push(y.premultiplyAlpha),g.push(y.flipY),g.push(y.unpackAlignment),g.push(y.colorSpace),g.join()}function Q(y,g){const F=n.get(y);if(y.isVideoTexture&&D(y),y.isRenderTargetTexture===!1&&y.isExternalTexture!==!0&&y.version>0&&F.__version!==y.version){const k=y.image;if(k===null)Re("WebGLRenderer: Texture marked for update but no image data found.");else if(k.complete===!1)Re("WebGLRenderer: Texture marked for update but image is incomplete");else{Ce(F,y,g);return}}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,F.__webglTexture,i.TEXTURE0+g)}function ee(y,g){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){Ce(F,y,g);return}else y.isExternalTexture&&(F.__webglTexture=y.sourceTexture?y.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,F.__webglTexture,i.TEXTURE0+g)}function se(y,g){const F=n.get(y);if(y.isRenderTargetTexture===!1&&y.version>0&&F.__version!==y.version){Ce(F,y,g);return}t.bindTexture(i.TEXTURE_3D,F.__webglTexture,i.TEXTURE0+g)}function K(y,g){const F=n.get(y);if(y.isCubeDepthTexture!==!0&&y.version>0&&F.__version!==y.version){Le(F,y,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,F.__webglTexture,i.TEXTURE0+g)}const ne={[zr]:i.REPEAT,[mn]:i.CLAMP_TO_EDGE,[Gr]:i.MIRRORED_REPEAT},Ne={[bt]:i.NEAREST,[Lc]:i.NEAREST_MIPMAP_NEAREST,[Wi]:i.NEAREST_MIPMAP_LINEAR,[wt]:i.LINEAR,[qs]:i.LINEAR_MIPMAP_NEAREST,[Vn]:i.LINEAR_MIPMAP_LINEAR},je={[Uc]:i.NEVER,[zc]:i.ALWAYS,[Nc]:i.LESS,[wa]:i.LEQUAL,[Fc]:i.EQUAL,[Ca]:i.GEQUAL,[Oc]:i.GREATER,[Bc]:i.NOTEQUAL};function We(y,g){if(g.type===nn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===wt||g.magFilter===qs||g.magFilter===Wi||g.magFilter===Vn||g.minFilter===wt||g.minFilter===qs||g.minFilter===Wi||g.minFilter===Vn)&&Re("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,ne[g.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,ne[g.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,ne[g.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,Ne[g.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,Ne[g.minFilter]),g.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,je[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===bt||g.minFilter!==Wi&&g.minFilter!==Vn||g.type===nn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function J(y,g){let F=!1;y.__webglInit===void 0&&(y.__webglInit=!0,g.addEventListener("dispose",w));const k=g.source;let W=m.get(k);W===void 0&&(W={},m.set(k,W));const ie=G(g);if(ie!==y.__cacheKey){W[ie]===void 0&&(W[ie]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,F=!0),W[ie].usedTimes++;const oe=W[y.__cacheKey];oe!==void 0&&(W[y.__cacheKey].usedTimes--,oe.usedTimes===0&&P(g)),y.__cacheKey=ie,y.__webglTexture=W[ie].texture}return F}function ae(y,g,F){return Math.floor(Math.floor(y/F)/g)}function te(y,g,F,k){const ie=y.updateRanges;if(ie.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,F,k,g.data);else{ie.sort((Se,de)=>Se.start-de.start);let oe=0;for(let Se=1;Se<ie.length;Se++){const de=ie[oe],ce=ie[Se],be=de.start+de.count,Ae=ae(ce.start,g.width,4),De=ae(de.start,g.width,4);ce.start<=be+1&&Ae===De&&ae(ce.start+ce.count-1,g.width,4)===Ae?de.count=Math.max(de.count,ce.start+ce.count-de.start):(++oe,ie[oe]=ce)}ie.length=oe+1;const q=t.getParameter(i.UNPACK_ROW_LENGTH),$=t.getParameter(i.UNPACK_SKIP_PIXELS),le=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let Se=0,de=ie.length;Se<de;Se++){const ce=ie[Se],be=Math.floor(ce.start/4),Ae=Math.ceil(ce.count/4),De=be%g.width,L=Math.floor(be/g.width),re=Ae,Z=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,De),t.pixelStorei(i.UNPACK_SKIP_ROWS,L),t.texSubImage2D(i.TEXTURE_2D,0,De,L,re,Z,F,k,g.data)}y.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,q),t.pixelStorei(i.UNPACK_SKIP_PIXELS,$),t.pixelStorei(i.UNPACK_SKIP_ROWS,le)}}function Ce(y,g,F){let k=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(k=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(k=i.TEXTURE_3D);const W=J(y,g),ie=g.source;t.bindTexture(k,y.__webglTexture,i.TEXTURE0+F);const oe=n.get(ie);if(ie.version!==oe.__version||W===!0){if(t.activeTexture(i.TEXTURE0+F),(typeof ImageBitmap<"u"&&g.image instanceof ImageBitmap)===!1){const Z=ze.getPrimaries(ze.workingColorSpace),he=g.colorSpace===Pn?null:ze.getPrimaries(g.colorSpace),me=g.colorSpace===Pn||Z===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,me)}t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment);let $=p(g.image,!1,s.maxTextureSize);$=Lt(g,$);const le=r.convert(g.format,g.colorSpace),Se=r.convert(g.type);let de=S(g.internalFormat,le,Se,g.normalized,g.colorSpace,g.isVideoTexture);We(k,g);let ce;const be=g.mipmaps,Ae=g.isVideoTexture!==!0,De=oe.__version===void 0||W===!0,L=ie.dataReady,re=b(g,$);if(g.isDepthTexture)de=A(g.format===Hn,g.type),De&&(Ae?t.texStorage2D(i.TEXTURE_2D,1,de,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,de,$.width,$.height,0,le,Se,null));else if(g.isDataTexture)if(be.length>0){Ae&&De&&t.texStorage2D(i.TEXTURE_2D,re,de,be[0].width,be[0].height);for(let Z=0,he=be.length;Z<he;Z++)ce=be[Z],Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ce.width,ce.height,le,Se,ce.data):t.texImage2D(i.TEXTURE_2D,Z,de,ce.width,ce.height,0,le,Se,ce.data);g.generateMipmaps=!1}else Ae?(De&&t.texStorage2D(i.TEXTURE_2D,re,de,$.width,$.height),L&&te(g,$,le,Se)):t.texImage2D(i.TEXTURE_2D,0,de,$.width,$.height,0,le,Se,$.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){Ae&&De&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,de,be[0].width,be[0].height,$.depth);for(let Z=0,he=be.length;Z<he;Z++)if(ce=be[Z],g.format!==Kt)if(le!==null)if(Ae){if(L)if(g.layerUpdates.size>0){const me=No(ce.width,ce.height,g.format,g.type);for(const j of g.layerUpdates){const Me=ce.data.subarray(j*me/ce.data.BYTES_PER_ELEMENT,(j+1)*me/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,j,ce.width,ce.height,1,le,Me)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ce.width,ce.height,$.depth,le,ce.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Z,de,ce.width,ce.height,$.depth,0,ce.data,0,0);else Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ae?L&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Z,0,0,0,ce.width,ce.height,$.depth,le,Se,ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Z,de,ce.width,ce.height,$.depth,0,le,Se,ce.data)}else{Ae&&De&&t.texStorage2D(i.TEXTURE_2D,re,de,be[0].width,be[0].height);for(let Z=0,he=be.length;Z<he;Z++)ce=be[Z],g.format!==Kt?le!==null?Ae?L&&t.compressedTexSubImage2D(i.TEXTURE_2D,Z,0,0,ce.width,ce.height,le,ce.data):t.compressedTexImage2D(i.TEXTURE_2D,Z,de,ce.width,ce.height,0,ce.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,ce.width,ce.height,le,Se,ce.data):t.texImage2D(i.TEXTURE_2D,Z,de,ce.width,ce.height,0,le,Se,ce.data)}else if(g.isDataArrayTexture)if(Ae){if(De&&t.texStorage3D(i.TEXTURE_2D_ARRAY,re,de,$.width,$.height,$.depth),L)if(g.layerUpdates.size>0){const Z=No($.width,$.height,g.format,g.type);for(const he of g.layerUpdates){const me=$.data.subarray(he*Z/$.data.BYTES_PER_ELEMENT,(he+1)*Z/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,he,$.width,$.height,1,le,Se,me)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,le,Se,$.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,de,$.width,$.height,$.depth,0,le,Se,$.data);else if(g.isData3DTexture)Ae?(De&&t.texStorage3D(i.TEXTURE_3D,re,de,$.width,$.height,$.depth),L&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,le,Se,$.data)):t.texImage3D(i.TEXTURE_3D,0,de,$.width,$.height,$.depth,0,le,Se,$.data);else if(g.isFramebufferTexture){if(De)if(Ae)t.texStorage2D(i.TEXTURE_2D,re,de,$.width,$.height);else{let Z=$.width,he=$.height;for(let me=0;me<re;me++)t.texImage2D(i.TEXTURE_2D,me,de,Z,he,0,le,Se,null),Z>>=1,he>>=1}}else if(g.isHTMLTexture){if("texElementImage2D"in i){const Z=i.canvas;if(Z.hasAttribute("layoutsubtree")||Z.setAttribute("layoutsubtree","true"),$.parentNode!==Z){Z.appendChild($),f.add(g),Z.onpaint=he=>{const me=he.changedElements;for(const j of f)me.includes(j.image)&&(j.needsUpdate=!0)},Z.requestPaint();return}if(i.texElementImage2D.length===3)i.texElementImage2D(i.TEXTURE_2D,i.RGBA8,$);else{const me=i.RGBA,j=i.RGBA,Me=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,0,me,j,Me,$)}i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(be.length>0){if(Ae&&De){const Z=qe(be[0]);t.texStorage2D(i.TEXTURE_2D,re,de,Z.width,Z.height)}for(let Z=0,he=be.length;Z<he;Z++)ce=be[Z],Ae?L&&t.texSubImage2D(i.TEXTURE_2D,Z,0,0,le,Se,ce):t.texImage2D(i.TEXTURE_2D,Z,de,le,Se,ce);g.generateMipmaps=!1}else if(Ae){if(De){const Z=qe($);t.texStorage2D(i.TEXTURE_2D,re,de,Z.width,Z.height)}L&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,le,Se,$)}else t.texImage2D(i.TEXTURE_2D,0,de,le,Se,$);u(g)&&T(k),oe.__version=ie.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function Le(y,g,F){if(g.image.length!==6)return;const k=J(y,g),W=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+F);const ie=n.get(W);if(W.version!==ie.__version||k===!0){t.activeTexture(i.TEXTURE0+F);const oe=ze.getPrimaries(ze.workingColorSpace),q=g.colorSpace===Pn?null:ze.getPrimaries(g.colorSpace),$=g.colorSpace===Pn||oe===q?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,$);const le=g.isCompressedTexture||g.image[0].isCompressedTexture,Se=g.image[0]&&g.image[0].isDataTexture,de=[];for(let j=0;j<6;j++)!le&&!Se?de[j]=p(g.image[j],!0,s.maxCubemapSize):de[j]=Se?g.image[j].image:g.image[j],de[j]=Lt(g,de[j]);const ce=de[0],be=r.convert(g.format,g.colorSpace),Ae=r.convert(g.type),De=S(g.internalFormat,be,Ae,g.normalized,g.colorSpace),L=g.isVideoTexture!==!0,re=ie.__version===void 0||k===!0,Z=W.dataReady;let he=b(g,ce);We(i.TEXTURE_CUBE_MAP,g);let me;if(le){L&&re&&t.texStorage2D(i.TEXTURE_CUBE_MAP,he,De,ce.width,ce.height);for(let j=0;j<6;j++){me=de[j].mipmaps;for(let Me=0;Me<me.length;Me++){const xe=me[Me];g.format!==Kt?be!==null?L?Z&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,be,xe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,De,xe.width,xe.height,0,xe.data):Re("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,xe.width,xe.height,be,Ae,xe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,De,xe.width,xe.height,0,be,Ae,xe.data)}}}else{if(me=g.mipmaps,L&&re){me.length>0&&he++;const j=qe(de[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,he,De,j.width,j.height)}for(let j=0;j<6;j++)if(Se){L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,de[j].width,de[j].height,be,Ae,de[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,De,de[j].width,de[j].height,0,be,Ae,de[j].data);for(let Me=0;Me<me.length;Me++){const rt=me[Me].image[j].image;L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,rt.width,rt.height,be,Ae,rt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,De,rt.width,rt.height,0,be,Ae,rt.data)}}else{L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,be,Ae,de[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,De,be,Ae,de[j]);for(let Me=0;Me<me.length;Me++){const xe=me[Me];L?Z&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,be,Ae,xe.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,De,be,Ae,xe.image[j])}}}u(g)&&T(i.TEXTURE_CUBE_MAP),ie.__version=W.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function Te(y,g,F,k,W,ie){const oe=r.convert(F.format,F.colorSpace),q=r.convert(F.type),$=S(F.internalFormat,oe,q,F.normalized,F.colorSpace),le=n.get(g),Se=n.get(F);if(Se.__renderTarget=g,!le.__hasExternalTextures){const de=Math.max(1,g.width>>ie),ce=Math.max(1,g.height>>ie);W===i.TEXTURE_3D||W===i.TEXTURE_2D_ARRAY?t.texImage3D(W,ie,$,de,ce,g.depth,0,oe,q,null):t.texImage2D(W,ie,$,de,ce,0,oe,q,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),ut(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,k,W,Se.__webglTexture,0,st(g)):(W===i.TEXTURE_2D||W>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&W<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,k,W,Se.__webglTexture,ie),t.bindFramebuffer(i.FRAMEBUFFER,null)}function lt(y,g,F){if(i.bindRenderbuffer(i.RENDERBUFFER,y),g.depthBuffer){const k=g.depthTexture,W=k&&k.isDepthTexture?k.type:null,ie=A(g.stencilBuffer,W),oe=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;ut(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,st(g),ie,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,st(g),ie,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ie,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,y)}else{const k=g.textures;for(let W=0;W<k.length;W++){const ie=k[W],oe=r.convert(ie.format,ie.colorSpace),q=r.convert(ie.type),$=S(ie.internalFormat,oe,q,ie.normalized,ie.colorSpace);ut(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,st(g),$,g.width,g.height):F?i.renderbufferStorageMultisample(i.RENDERBUFFER,st(g),$,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,$,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Be(y,g,F){const k=g.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");const W=n.get(g.depthTexture);if(W.__renderTarget=g,(!W.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),k){if(W.__webglInit===void 0&&(W.__webglInit=!0,g.depthTexture.addEventListener("dispose",w)),W.__webglTexture===void 0){W.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,W.__webglTexture),We(i.TEXTURE_CUBE_MAP,g.depthTexture);const le=r.convert(g.depthTexture.format),Se=r.convert(g.depthTexture.type);let de;g.depthTexture.format===vn?de=i.DEPTH_COMPONENT24:g.depthTexture.format===Hn&&(de=i.DEPTH24_STENCIL8);for(let ce=0;ce<6;ce++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0,de,g.width,g.height,0,le,Se,null)}}else Q(g.depthTexture,0);const ie=W.__webglTexture,oe=st(g),q=k?i.TEXTURE_CUBE_MAP_POSITIVE_X+F:i.TEXTURE_2D,$=g.depthTexture.format===Hn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(g.depthTexture.format===vn)ut(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,q,ie,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,$,q,ie,0);else if(g.depthTexture.format===Hn)ut(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,$,q,ie,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,$,q,ie,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function $e(y){const g=n.get(y),F=y.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==y.depthTexture){const k=y.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),k){const W=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,k.removeEventListener("dispose",W)};k.addEventListener("dispose",W),g.__depthDisposeCallback=W}g.__boundDepthTexture=k}if(y.depthTexture&&!g.__autoAllocateDepthBuffer)if(F)for(let k=0;k<6;k++)Be(g.__webglFramebuffer[k],y,k);else{const k=y.texture.mipmaps;k&&k.length>0?Be(g.__webglFramebuffer[0],y,0):Be(g.__webglFramebuffer,y,0)}else if(F){g.__webglDepthbuffer=[];for(let k=0;k<6;k++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[k]),g.__webglDepthbuffer[k]===void 0)g.__webglDepthbuffer[k]=i.createRenderbuffer(),lt(g.__webglDepthbuffer[k],y,!1);else{const W=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=g.__webglDepthbuffer[k];i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,W,i.RENDERBUFFER,ie)}}else{const k=y.texture.mipmaps;if(k&&k.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),lt(g.__webglDepthbuffer,y,!1);else{const W=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ie=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ie),i.framebufferRenderbuffer(i.FRAMEBUFFER,W,i.RENDERBUFFER,ie)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Xe(y,g,F){const k=n.get(y);g!==void 0&&Te(k.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),F!==void 0&&$e(y)}function ke(y){const g=y.texture,F=n.get(y),k=n.get(g);y.addEventListener("dispose",x);const W=y.textures,ie=y.isWebGLCubeRenderTarget===!0,oe=W.length>1;if(oe||(k.__webglTexture===void 0&&(k.__webglTexture=i.createTexture()),k.__version=g.version,a.memory.textures++),ie){F.__webglFramebuffer=[];for(let q=0;q<6;q++)if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer[q]=[];for(let $=0;$<g.mipmaps.length;$++)F.__webglFramebuffer[q][$]=i.createFramebuffer()}else F.__webglFramebuffer[q]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){F.__webglFramebuffer=[];for(let q=0;q<g.mipmaps.length;q++)F.__webglFramebuffer[q]=i.createFramebuffer()}else F.__webglFramebuffer=i.createFramebuffer();if(oe)for(let q=0,$=W.length;q<$;q++){const le=n.get(W[q]);le.__webglTexture===void 0&&(le.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&ut(y)===!1){F.__webglMultisampledFramebuffer=i.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let q=0;q<W.length;q++){const $=W[q];F.__webglColorRenderbuffer[q]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,F.__webglColorRenderbuffer[q]);const le=r.convert($.format,$.colorSpace),Se=r.convert($.type),de=S($.internalFormat,le,Se,$.normalized,$.colorSpace,y.isXRRenderTarget===!0),ce=st(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,ce,de,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+q,i.RENDERBUFFER,F.__webglColorRenderbuffer[q])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(F.__webglDepthRenderbuffer=i.createRenderbuffer(),lt(F.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ie){t.bindTexture(i.TEXTURE_CUBE_MAP,k.__webglTexture),We(i.TEXTURE_CUBE_MAP,g);for(let q=0;q<6;q++)if(g.mipmaps&&g.mipmaps.length>0)for(let $=0;$<g.mipmaps.length;$++)Te(F.__webglFramebuffer[q][$],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,$);else Te(F.__webglFramebuffer[q],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+q,0);u(g)&&T(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let q=0,$=W.length;q<$;q++){const le=W[q],Se=n.get(le);let de=i.TEXTURE_2D;(y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(de=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,Se.__webglTexture),We(de,le),Te(F.__webglFramebuffer,y,le,i.COLOR_ATTACHMENT0+q,de,0),u(le)&&T(de)}t.unbindTexture()}else{let q=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(q=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(q,k.__webglTexture),We(q,g),g.mipmaps&&g.mipmaps.length>0)for(let $=0;$<g.mipmaps.length;$++)Te(F.__webglFramebuffer[$],y,g,i.COLOR_ATTACHMENT0,q,$);else Te(F.__webglFramebuffer,y,g,i.COLOR_ATTACHMENT0,q,0);u(g)&&T(q),t.unbindTexture()}y.depthBuffer&&$e(y)}function dt(y){const g=y.textures;for(let F=0,k=g.length;F<k;F++){const W=g[F];if(u(W)){const ie=R(y),oe=n.get(W).__webglTexture;t.bindTexture(ie,oe),T(ie),t.unbindTexture()}}}const mt=[],St=[];function yt(y){if(y.samples>0){if(ut(y)===!1){const g=y.textures,F=y.width,k=y.height;let W=i.COLOR_BUFFER_BIT;const ie=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(y),q=g.length>1;if(q)for(let le=0;le<g.length;le++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const $=y.texture.mipmaps;$&&$.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let le=0;le<g.length;le++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(W|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(W|=i.STENCIL_BUFFER_BIT)),q){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);const Se=n.get(g[le]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Se,0)}i.blitFramebuffer(0,0,F,k,0,0,F,k,W,i.NEAREST),c===!0&&(mt.length=0,St.length=0,mt.push(i.COLOR_ATTACHMENT0+le),y.depthBuffer&&y.resolveDepthBuffer===!1&&(mt.push(ie),St.push(ie),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,St)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,mt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),q)for(let le=0;le<g.length;le++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,oe.__webglColorRenderbuffer[le]);const Se=n.get(g[le]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,Se,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&c){const g=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function st(y){return Math.min(s.maxSamples,y.samples)}function ut(y){const g=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function D(y){const g=a.render.frame;d.get(y)!==g&&(d.set(y,g),y.update())}function Lt(y,g){const F=y.colorSpace,k=y.format,W=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||F!==Ps&&F!==Pn&&(ze.getTransfer(F)===Ye?(k!==Kt||W!==Bt)&&Re("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):He("WebGLTextures: Unsupported texture color space:",F)),g}function qe(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(l.width=y.naturalWidth||y.width,l.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(l.width=y.displayWidth,l.height=y.displayHeight):(l.width=y.width,l.height=y.height),l}this.allocateTextureUnit=X,this.resetTextureUnits=H,this.getTextureUnits=Y,this.setTextureUnits=O,this.setTexture2D=Q,this.setTexture2DArray=ee,this.setTexture3D=se,this.setTextureCube=K,this.rebindTextures=Xe,this.setupRenderTarget=ke,this.updateRenderTargetMipmap=dt,this.updateMultisampleRenderTarget=yt,this.setupDepthRenderbuffer=$e,this.setupFrameBufferTexture=Te,this.useMultisampledRTT=ut,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function vm(i,e){function t(n,s=Pn){let r;const a=ze.getTransfer(s);if(n===Bt)return i.UNSIGNED_BYTE;if(n===ya)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ba)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ml)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Sl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===xl)return i.BYTE;if(n===vl)return i.SHORT;if(n===Ui)return i.UNSIGNED_SHORT;if(n===Ea)return i.INT;if(n===ln)return i.UNSIGNED_INT;if(n===nn)return i.FLOAT;if(n===xn)return i.HALF_FLOAT;if(n===El)return i.ALPHA;if(n===yl)return i.RGB;if(n===Kt)return i.RGBA;if(n===vn)return i.DEPTH_COMPONENT;if(n===Hn)return i.DEPTH_STENCIL;if(n===bl)return i.RED;if(n===Ta)return i.RED_INTEGER;if(n===qn)return i.RG;if(n===Aa)return i.RG_INTEGER;if(n===Ra)return i.RGBA_INTEGER;if(n===ys||n===bs||n===Ts||n===As)if(a===Ye)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ys)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ts)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===As)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ys)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===bs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ts)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===As)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===kr||n===Vr||n===Hr||n===Wr)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===kr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Vr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Hr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Wr)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Xr||n===qr||n===Yr||n===Kr||n===Zr||n===ws||n===$r)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Xr||n===qr)return a===Ye?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Yr)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(n===Kr)return r.COMPRESSED_R11_EAC;if(n===Zr)return r.COMPRESSED_SIGNED_R11_EAC;if(n===ws)return r.COMPRESSED_RG11_EAC;if(n===$r)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Jr||n===Qr||n===jr||n===ea||n===ta||n===na||n===ia||n===sa||n===ra||n===aa||n===oa||n===la||n===ca||n===ha)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Jr)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Qr)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===jr)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===ea)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ta)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===na)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ia)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===sa)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===ra)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===aa)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===oa)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===la)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ca)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ha)return a===Ye?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===da||n===ua||n===fa)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===da)return a===Ye?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ua)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===fa)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===pa||n===ma||n===Cs||n===ga)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===pa)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ma)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Cs)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ga)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ni?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Mm=`
void main() {
...
}`;class Em{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Ul(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Zt({vertexShader:Mm,fragmentShader:Sm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Wt(new ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class ym extends Un{constructor(e,t){super();const n=this;let s=null,r=1,a=null,o="local-floor",c=1,l=null,d=null,f=null,h=null,m=null,_=null;const M=typeof XRWebGLBinding<"u",p=new Em,u={},T=t.getContextAttributes();let R=null,S=null;const A=[],b=[],w=new we;let x=null;const E=new Vt;E.viewport=new it;const P=new Vt;P.viewport=new it;const C=[E,P],N=new Ph;let H=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(J){let ae=A[J];return ae===void 0&&(ae=new js,A[J]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function(J){let ae=A[J];return ae===void 0&&(ae=new js,A[J]=ae),ae.getGripSpace()},this.getHand=function(J){let ae=A[J];return ae===void 0&&(ae=new js,A[J]=ae),ae.getHandSpace()};function O(J){const ae=b.indexOf(J.inputSource);if(ae===-1)return;const te=A[ae];te!==void 0&&(te.update(J.inputSource,J.frame,l||a),te.dispatchEvent({type:J.type,data:J.inputSource}))}function X(){s.removeEventListener("select",O),s.removeEventListener("selectstart",O),s.removeEventListener("selectend",O),s.removeEventListener("squeeze",O),s.removeEventListener("squeezestart",O),s.removeEventListener("squeezeend",O),s.removeEventListener("end",X),s.removeEventListener("inputsourceschange",G);for(let J=0;J<A.length;J++){const ae=b[J];ae!==null&&(b[J]=null,A[J].disconnect(ae))}H=null,Y=null,p.reset();for(const J in u)delete u[J];e.setRenderTarget(R),m=null,h=null,f=null,s=null,S=null,We.stop(),n.isPresenting=!1,e.setPixelRatio(x),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(J){r=J,n.isPresenting===!0&&Re("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(J){o=J,n.isPresenting===!0&&Re("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(J){l=J},this.getBaseLayer=function(){return h!==null?h:m},this.getBinding=function(){return f===null&&M&&(f=new XRWebGLBinding(s,t)),f},this.getFrame=function(){return _},this.getSession=function(){return s},this.setSession=async function(J){if(s=J,s!==null){if(R=e.getRenderTarget(),s.addEventListener("select",O),s.addEventListener("selectstart",O),s.addEventListener("selectend",O),s.addEventListener("squeeze",O),s.addEventListener("squeezestart",O),s.addEventListener("squeezeend",O),s.addEventListener("end",X),s.addEventListener("inputsourceschange",G),T.xrCompatible!==!0&&await t.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(w),M&&"createProjectionLayer"in XRWebGLBinding.prototype){let te=null,Ce=null,Le=null;T.depth&&(Le=T.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,te=T.stencil?Hn:vn,Ce=T.stencil?Ni:ln);const Te={colorFormat:t.RGBA8,depthFormat:Le,scaleFactor:r};f=this.getBinding(),h=f.createProjectionLayer(Te),s.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),S=new an(h.textureWidth,h.textureHeight,{format:Kt,type:Bt,depthTexture:new _i(h.textureWidth,h.textureHeight,Ce,void 0,void 0,void 0,void 0,void 0,void 0,te),stencilBuffer:T.stencil,colorSpace:e.outputColorSpace,samples:T.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const te={antialias:T.antialias,alpha:!0,depth:T.depth,stencil:T.stencil,framebufferScaleFactor:r};m=new XRWebGLLayer(s,t,te),s.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),S=new an(m.framebufferWidth,m.framebufferHeight,{format:Kt,type:Bt,colorSpace:e.outputColorSpace,stencilBuffer:T.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await s.requestReferenceSpace(o),We.setContext(s),We.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(s!==null)return s.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function G(J){for(let ae=0;ae<J.removed.length;ae++){const te=J.removed[ae],Ce=b.indexOf(te);Ce>=0&&(b[Ce]=null,A[Ce].disconnect(te))}for(let ae=0;ae<J.added.length;ae++){const te=J.added[ae];let Ce=b.indexOf(te);if(Ce===-1){for(let Te=0;Te<A.length;Te++)if(Te>=b.length){b.push(te),Ce=Te;break}else if(b[Te]===null){b[Te]=te,Ce=Te;break}if(Ce===-1)break}const Le=A[Ce];Le&&Le.connect(te)}}const Q=new I,ee=new I;function se(J,ae,te){Q.setFromMatrixPosition(ae.matrixWorld),ee.setFromMatrixPosition(te.matrixWorld);const Ce=Q.distanceTo(ee),Le=ae.projectionMatrix.elements,Te=te.projectionMatrix.elements,lt=Le[14]/(Le[10]-1),Be=Le[14]/(Le[10]+1),$e=(Le[9]+1)/Le[5],Xe=(Le[9]-1)/Le[5],ke=(Le[8]-1)/Le[0],dt=(Te[8]+1)/Te[0],mt=lt*ke,St=lt*dt,yt=Ce/(-ke+dt),st=yt*-ke;if(ae.matrixWorld.decompose(J.position,J.quaternion,J.scale),J.translateX(st),J.translateZ(yt),J.matrixWorld.compose(J.position,J.quaternion,J.scale),J.matrixWorldInverse.copy(J.matrixWorld).invert(),Le[10]===-1)J.projectionMatrix.copy(ae.projectionMatrix),J.projectionMatrixInverse.copy(ae.projectionMatrixInverse);else{const ut=lt+yt,D=Be+yt,Lt=mt-st,qe=St+(Ce-st),y=$e*Be/D*ut,g=Xe*Be/D*ut;J.projectionMatrix.makePerspective(Lt,qe,y,g,ut,D),J.projectionMatrixInverse.copy(J.projectionMatrix).invert()}}function K(J,ae){ae===null?J.matrixWorld.copy(J.matrix):J.matrixWorld.multiplyMatrices(ae.matrixWorld,J.matrix),J.matrixWorldInverse.copy(J.matrixWorld).invert()}this.updateCamera=function(J){if(s===null)return;let ae=J.near,te=J.far;p.texture!==null&&(p.depthNear>0&&(ae=p.depthNear),p.depthFar>0&&(te=p.depthFar)),N.near=P.near=E.near=ae,N.far=P.far=E.far=te,(H!==N.near||Y!==N.far)&&(s.updateRenderState({depthNear:N.near,depthFar:N.far}),H=N.near,Y=N.far),N.layers.mask=J.layers.mask|6,E.layers.mask=N.layers.mask&-5,P.layers.mask=N.layers.mask&-3;const Ce=J.parent,Le=N.cameras;K(N,Ce);for(let Te=0;Te<Le.length;Te++)K(Le[Te],Ce);Le.length===2?se(N,E,P):N.projectionMatrix.copy(E.projectionMatrix),ne(J,N,Ce)};function ne(J,ae,te){te===null?J.matrix.copy(ae.matrixWorld):(J.matrix.copy(te.matrixWorld),J.matrix.invert(),J.matrix.multiply(ae.matrixWorld)),J.matrix.decompose(J.position,J.quaternion,J.scale),J.updateMatrixWorld(!0),J.projectionMatrix.copy(ae.projectionMatrix),J.projectionMatrixInverse.copy(ae.projectionMatrixInverse),J.isPerspectiveCamera&&(J.fov=_a*2*Math.atan(1/J.projectionMatrix.elements[5]),J.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(h===null&&m===null))return c},this.setFoveation=function(J){c=J,h!==null&&(h.fixedFoveation=J),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=J)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(N)},this.getCameraTexture=function(J){return u[J]};let Ne=null;function je(J,ae){if(d=ae.getViewerPose(l||a),_=ae,d!==null){const te=d.views;m!==null&&(e.setRenderTargetFramebuffer(S,m.framebuffer),e.setRenderTarget(S));let Ce=!1;te.length!==N.cameras.length&&(N.cameras.length=0,Ce=!0);for(let Be=0;Be<te.length;Be++){const $e=te[Be];let Xe=null;if(m!==null)Xe=m.getViewport($e);else{const dt=f.getViewSubImage(h,$e);Xe=dt.viewport,Be===0&&(e.setRenderTargetTextures(S,dt.colorTexture,dt.depthStencilTexture),e.setRenderTarget(S))}let ke=C[Be];ke===void 0&&(ke=new Vt,ke.layers.enable(Be),ke.viewport=new it,C[Be]=ke),ke.matrix.fromArray($e.transform.matrix),ke.matrix.decompose(ke.position,ke.quaternion,ke.scale),ke.projectionMatrix.fromArray($e.projectionMatrix),ke.projectionMatrixInverse.copy(ke.projectionMatrix).invert(),ke.viewport.set(Xe.x,Xe.y,Xe.width,Xe.height),Be===0&&(N.matrix.copy(ke.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Ce===!0&&N.cameras.push(ke)}const Le=s.enabledFeatures;if(Le&&Le.includes("depth-sensing")&&s.depthUsage=="gpu-optimized"&&M){f=n.getBinding();const Be=f.getDepthInformation(te[0]);Be&&Be.isValid&&Be.texture&&p.init(Be,s.renderState)}if(Le&&Le.includes("camera-access")&&M){e.state.unbindTexture(),f=n.getBinding();for(let Be=0;Be<te.length;Be++){const $e=te[Be].camera;if($e){let Xe=u[$e];Xe||(Xe=new Ul,u[$e]=Xe);const ke=f.getCameraImage($e);Xe.sourceTexture=ke}}}}for(let te=0;te<A.length;te++){const Ce=b[te],Le=A[te];Ce!==null&&Le!==void 0&&Le.update(Ce,ae,l||a)}Ne&&Ne(J,ae),ae.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ae}),_=null}const We=new Bl;We.setAnimationLoop(je),this.setAnimationLoop=function(J){Ne=J},this.dispose=function(){}}}const bm=new nt,Xl=new Pe;Xl.set(-1,0,0,0,1,0,0,0,1);function Tm(i,e){function t(p,u){p.matrixAutoUpdate===!0&&p.updateMatrix(),u.value.copy(p.matrix)}function n(p,u){u.color.getRGB(p.fogColor.value,Nl(i)),u.isFog?(p.fogNear.value=u.near,p.fogFar.value=u.far):u.isFogExp2&&(p.fogDensity.value=u.density)}function s(p,u,T,R,S){u.isNodeMaterial?u.uniformsNeedUpdate=!1:u.isMeshBasicMaterial?r(p,u):u.isMeshLambertMaterial?(r(p,u),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)):u.isMeshToonMaterial?(r(p,u),f(p,u)):u.isMeshPhongMaterial?(r(p,u),d(p,u),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)):u.isMeshStandardMaterial?(r(p,u),h(p,u),u.isMeshPhysicalMaterial&&m(p,u,S)):u.isMeshMatcapMaterial?(r(p,u),_(p,u)):u.isMeshDepthMaterial?r(p,u):u.isMeshDistanceMaterial?(r(p,u),M(p,u)):u.isMeshNormalMaterial?r(p,u):u.isLineBasicMaterial?(a(p,u),u.isLineDashedMaterial&&o(p,u)):u.isPointsMaterial?c(p,u,T,R):u.isSpriteMaterial?l(p,u):u.isShadowMaterial?(p.color.value.copy(u.color),p.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function r(p,u){p.opacity.value=u.opacity,u.color&&p.diffuse.value.copy(u.color),u.emissive&&p.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.bumpMap&&(p.bumpMap.value=u.bumpMap,t(u.bumpMap,p.bumpMapTransform),p.bumpScale.value=u.bumpScale,u.side===Ut&&(p.bumpScale.value*=-1)),u.normalMap&&(p.normalMap.value=u.normalMap,t(u.normalMap,p.normalMapTransform),p.normalScale.value.copy(u.normalScale),u.side===Ut&&p.normalScale.value.negate()),u.displacementMap&&(p.displacementMap.value=u.displacementMap,t(u.displacementMap,p.displacementMapTransform),p.displacementScale.value=u.displacementScale,p.displacementBias.value=u.displacementBias),u.emissiveMap&&(p.emissiveMap.value=u.emissiveMap,t(u.emissiveMap,p.emissiveMapTransform)),u.specularMap&&(p.specularMap.value=u.specularMap,t(u.specularMap,p.specularMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest);const T=e.get(u),R=T.envMap,S=T.envMapRotation;R&&(p.envMap.value=R,p.envMapRotation.value.setFromMatrix4(bm.makeRotationFromEuler(S)).transpose(),R.isCubeTexture&&R.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(Xl),p.reflectivity.value=u.reflectivity,p.ior.value=u.ior,p.refractionRatio.value=u.refractionRatio),u.lightMap&&(p.lightMap.value=u.lightMap,p.lightMapIntensity.value=u.lightMapIntensity,t(u.lightMap,p.lightMapTransform)),u.aoMap&&(p.aoMap.value=u.aoMap,p.aoMapIntensity.value=u.aoMapIntensity,t(u.aoMap,p.aoMapTransform))}function a(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform))}function o(p,u){p.dashSize.value=u.dashSize,p.totalSize.value=u.dashSize+u.gapSize,p.scale.value=u.scale}function c(p,u,T,R){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.size.value=u.size*T,p.scale.value=R*.5,u.map&&(p.map.value=u.map,t(u.map,p.uvTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function l(p,u){p.diffuse.value.copy(u.color),p.opacity.value=u.opacity,p.rotation.value=u.rotation,u.map&&(p.map.value=u.map,t(u.map,p.mapTransform)),u.alphaMap&&(p.alphaMap.value=u.alphaMap,t(u.alphaMap,p.alphaMapTransform)),u.alphaTest>0&&(p.alphaTest.value=u.alphaTest)}function d(p,u){p.specular.value.copy(u.specular),p.shininess.value=Math.max(u.shininess,1e-4)}function f(p,u){u.gradientMap&&(p.gradientMap.value=u.gradientMap)}function h(p,u){p.metalness.value=u.metalness,u.metalnessMap&&(p.metalnessMap.value=u.metalnessMap,t(u.metalnessMap,p.metalnessMapTransform)),p.roughness.value=u.roughness,u.roughnessMap&&(p.roughnessMap.value=u.roughnessMap,t(u.roughnessMap,p.roughnessMapTransform)),u.envMap&&(p.envMapIntensity.value=u.envMapIntensity)}function m(p,u,T){p.ior.value=u.ior,u.sheen>0&&(p.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),p.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(p.sheenColorMap.value=u.sheenColorMap,t(u.sheenColorMap,p.sheenColorMapTransform)),u.sheenRoughnessMap&&(p.sheenRoughnessMap.value=u.sheenRoughnessMap,t(u.sheenRoughnessMap,p.sheenRoughnessMapTransform))),u.clearcoat>0&&(p.clearcoat.value=u.clearcoat,p.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(p.clearcoatMap.value=u.clearcoatMap,t(u.clearcoatMap,p.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,t(u.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(p.clearcoatNormalMap.value=u.clearcoatNormalMap,t(u.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Ut&&p.clearcoatNormalScale.value.negate())),u.dispersion>0&&(p.dispersion.value=u.dispersion),u.iridescence>0&&(p.iridescence.value=u.iridescence,p.iridescenceIOR.value=u.iridescenceIOR,p.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(p.iridescenceMap.value=u.iridescenceMap,t(u.iridescenceMap,p.iridescenceMapTransform)),u.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=u.iridescenceThicknessMap,t(u.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),u.transmission>0&&(p.transmission.value=u.transmission,p.transmissionSamplerMap.value=T.texture,p.transmissionSamplerSize.value.set(T.width,T.height),u.transmissionMap&&(p.transmissionMap.value=u.transmissionMap,t(u.transmissionMap,p.transmissionMapTransform)),p.thickness.value=u.thickness,u.thicknessMap&&(p.thicknessMap.value=u.thicknessMap,t(u.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=u.attenuationDistance,p.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(p.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(p.anisotropyMap.value=u.anisotropyMap,t(u.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=u.specularIntensity,p.specularColor.value.copy(u.specularColor),u.specularColorMap&&(p.specularColorMap.value=u.specularColorMap,t(u.specularColorMap,p.specularColorMapTransform)),u.specularIntensityMap&&(p.specularIntensityMap.value=u.specularIntensityMap,t(u.specularIntensityMap,p.specularIntensityMapTransform))}function _(p,u){u.matcap&&(p.matcap.value=u.matcap)}function M(p,u){const T=e.get(u).light;p.referencePosition.value.setFromMatrixPosition(T.matrixWorld),p.nearDistance.value=T.shadow.camera.near,p.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:s}}function Am(i,e,t,n){let s={},r={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(S,A){const b=A.program;n.uniformBlockBinding(S,b)}function l(S,A){let b=s[S.id];b===void 0&&(p(S),b=d(S),s[S.id]=b,S.addEventListener("dispose",T));const w=A.program;n.updateUBOMapping(S,w);const x=e.render.frame;r[S.id]!==x&&(h(S),r[S.id]=x)}function d(S){const A=f();S.__bindingPointIndex=A;const b=i.createBuffer(),w=S.__size,x=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,b),i.bufferData(i.UNIFORM_BUFFER,w,x),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,b),b}function f(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return He("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(S){const A=s[S.id],b=S.uniforms,w=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let x=0,E=b.length;x<E;x++){const P=b[x];if(Array.isArray(P))for(let C=0,N=P.length;C<N;C++)m(P[C],x,C,w);else m(P,x,0,w)}i.bindBuffer(i.UNIFORM_BUFFER,null)}function m(S,A,b,w){if(M(S,A,b,w)===!0){const x=S.__offset,E=S.value;if(Array.isArray(E)){let P=0;for(let C=0;C<E.length;C++){const N=E[C],H=u(N);_(N,S.__data,P),typeof N!="number"&&typeof N!="boolean"&&!N.isMatrix3&&!ArrayBuffer.isView(N)&&(P+=H.storage/Float32Array.BYTES_PER_ELEMENT)}}else _(E,S.__data,0);i.bufferSubData(i.UNIFORM_BUFFER,x,S.__data)}}function _(S,A,b){typeof S=="number"||typeof S=="boolean"?A[0]=S:S.isMatrix3?(A[0]=S.elements[0],A[1]=S.elements[1],A[2]=S.elements[2],A[3]=0,A[4]=S.elements[3],A[5]=S.elements[4],A[6]=S.elements[5],A[7]=0,A[8]=S.elements[6],A[9]=S.elements[7],A[10]=S.elements[8],A[11]=0):ArrayBuffer.isView(S)?A.set(new S.constructor(S.buffer,S.byteOffset,A.length)):S.toArray(A,b)}function M(S,A,b,w){const x=S.value,E=A+"_"+b;if(w[E]===void 0)return typeof x=="number"||typeof x=="boolean"?w[E]=x:ArrayBuffer.isView(x)?w[E]=x.slice():w[E]=x.clone(),!0;{const P=w[E];if(typeof x=="number"||typeof x=="boolean"){if(P!==x)return w[E]=x,!0}else{if(ArrayBuffer.isView(x))return!0;if(P.equals(x)===!1)return P.copy(x),!0}}return!1}function p(S){const A=S.uniforms;let b=0;const w=16;for(let E=0,P=A.length;E<P;E++){const C=Array.isArray(A[E])?A[E]:[A[E]];for(let N=0,H=C.length;N<H;N++){const Y=C[N],O=Array.isArray(Y.value)?Y.value:[Y.value];for(let X=0,G=O.length;X<G;X++){const Q=O[X],ee=u(Q),se=b%w,K=se%ee.boundary,ne=se+K;b+=K,ne!==0&&w-ne<ee.storage&&(b+=w-ne),Y.__data=new Float32Array(ee.storage/Float32Array.BYTES_PER_ELEMENT),Y.__offset=b,b+=ee.storage}}}const x=b%w;return x>0&&(b+=w-x),S.__size=b,S.__cache={},this}function u(S){const A={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(A.boundary=4,A.storage=4):S.isVector2?(A.boundary=8,A.storage=8):S.isVector3||S.isColor?(A.boundary=16,A.storage=12):S.isVector4?(A.boundary=16,A.storage=16):S.isMatrix3?(A.boundary=48,A.storage=48):S.isMatrix4?(A.boundary=64,A.storage=64):S.isTexture?Re("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(A.boundary=16,A.storage=S.byteLength):Re("WebGLRenderer: Unsupported uniform value type.",S),A}function T(S){const A=S.target;A.removeEventListener("dispose",T);const b=a.indexOf(A.__bindingPointIndex);a.splice(b,1),i.deleteBuffer(s[A.id]),delete s[A.id],delete r[A.id]}function R(){for(const S in s)i.deleteBuffer(s[S]);a=[],s={},r={}}return{bind:c,update:l,dispose:R}}const Rm=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let en=null;function wm(){return en===null&&(en=new hh(Rm,16,16,qn,xn),en.name="DFG_LUT",en.minFilter=wt,en.magFilter=wt,en.wrapS=mn,en.wrapT=mn,en.generateMipmaps=!1,en.needsUpdate=!0),en}class ql{constructor(e={}){const{canvas:t=kc(),context:n=null,depth:s=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:m=Bt}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=a;const M=m,p=new Set([Ra,Aa,Ta]),u=new Set([Bt,ln,Ui,Ni,ya,ba]),T=new Uint32Array(4),R=new Int32Array(4),S=new I;let A=null,b=null;const w=[],x=[];let E=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let C=!1,N=null,H=null,Y=null,O=null;this._outputColorSpace=kt;let X=0,G=0,Q=null,ee=-1,se=null;const K=new it,ne=new it;let Ne=null;const je=new Ge(0);let We=0,J=t.width,ae=t.height,te=1,Ce=null,Le=null;const Te=new it(0,0,J,ae),lt=new it(0,0,J,ae);let Be=!1;const $e=new La;let Xe=!1,ke=!1;const dt=new nt,mt=new I,St=new it,yt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let st=!1;function ut(){return Q===null?te:1}let D=n;function Lt(v,U){return t.getContext(v,U)}try{const v={alpha:!0,depth:s,stencil:r,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Sa}`),t.addEventListener("webglcontextlost",rt,!1),t.addEventListener("webglcontextrestored",et,!1),t.addEventListener("webglcontextcreationerror",$t,!1),D===null){const U="webgl2";if(D=Lt(U,v),D===null)throw Lt(U)?new Error("THREE.WebGLRenderer: Error creating WebGL context with your selected attributes."):new Error("THREE.WebGLRenderer: Error creating WebGL context.")}}catch(v){throw He("WebGLRenderer: "+v.message),v}let qe,y,g,F,k,W,ie,oe,q,$,le,Se,de,ce,be,Ae,De,L,re,Z,he,me,j;function Me(){qe=new wf(D),qe.init(),he=new vm(D,qe),y=new Mf(D,qe,e,he),g=new _m(D,qe),y.reversedDepthBuffer&&h&&g.buffers.depth.setReversed(!0),H=D.createFramebuffer(),Y=D.createFramebuffer(),O=D.createFramebuffer(),F=new Lf(D),k=new im,W=new xm(D,qe,g,k,y,he,F),ie=new Rf(P),oe=new Uh(D),me=new xf(D,oe),q=new Cf(D,oe,F,me),$=new If(D,q,oe,me,F),L=new Df(D,y,W),be=new Sf(k),le=new nm(P,ie,qe,y,me,be),Se=new Tm(P,k),de=new rm,ce=new dm(qe),De=new _f(P,ie,g,$,_,c),Ae=new gm(P,$,y),j=new Am(D,F,y,g),re=new vf(D,qe,F),Z=new Pf(D,qe,F),F.programs=le.programs,P.capabilities=y,P.extensions=qe,P.properties=k,P.renderLists=de,P.shadowMap=Ae,P.state=g,P.info=F}Me(),M!==Bt&&(E=new Nf(M,t.width,t.height,o,s,r));const xe=new ym(P,D);this.xr=xe,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const v=qe.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=qe.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return te},this.setPixelRatio=function(v){v!==void 0&&(te=v,this.setSize(J,ae,!1))},this.getSize=function(v){return v.set(J,ae)},this.setSize=function(v,U,V=!0){if(xe.isPresenting){Re("WebGLRenderer: Can't change size while VR device is presenting.");return}J=v,ae=U,t.width=Math.floor(v*te),t.height=Math.floor(U*te),V===!0&&(t.style.width=v+"px",t.style.height=U+"px"),E!==null&&E.setSize(t.width,t.height),this.setViewport(0,0,v,U)},this.getDrawingBufferSize=function(v){return v.set(J*te,ae*te).floor()},this.setDrawingBufferSize=function(v,U,V){J=v,ae=U,te=V,t.width=Math.floor(v*V),t.height=Math.floor(U*V),this.setViewport(0,0,v,U)},this.setEffects=function(v){if(M===Bt){He("WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(v){for(let U=0;U<v.length;U++)if(v[U].isOutputPass===!0){Re("WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}E.setEffects(v||[])},this.getCurrentViewport=function(v){return v.copy(K)},this.getViewport=function(v){return v.copy(Te)},this.setViewport=function(v,U,V,B){v.isVector4?Te.set(v.x,v.y,v.z,v.w):Te.set(v,U,V,B),g.viewport(K.copy(Te).multiplyScalar(te).round())},this.getScissor=function(v){return v.copy(lt)},this.setScissor=function(v,U,V,B){v.isVector4?lt.set(v.x,v.y,v.z,v.w):lt.set(v,U,V,B),g.scissor(ne.copy(lt).multiplyScalar(te).round())},this.getScissorTest=function(){return Be},this.setScissorTest=function(v){g.setScissorTest(Be=v)},this.setOpaqueSort=function(v){Ce=v},this.setTransparentSort=function(v){Le=v},this.getClearColor=function(v){return v.copy(De.getClearColor())},this.setClearColor=function(){De.setClearColor(...arguments)},this.getClearAlpha=function(){return De.getClearAlpha()},this.setClearAlpha=function(){De.setClearAlpha(...arguments)},this.clear=function(v=!0,U=!0,V=!0){let B=0;if(v){let z=!1;if(Q!==null){const pe=Q.texture.format;z=p.has(pe)}if(z){const pe=Q.texture.type,_e=u.has(pe),fe=De.getClearColor(),ve=De.getClearAlpha(),Ee=fe.r,Ie=fe.g,Fe=fe.b;_e?(T[0]=Ee,T[1]=Ie,T[2]=Fe,T[3]=ve,D.clearBufferuiv(D.COLOR,0,T)):(R[0]=Ee,R[1]=Ie,R[2]=Fe,R[3]=ve,D.clearBufferiv(D.COLOR,0,R))}else B|=D.COLOR_BUFFER_BIT}U&&(B|=D.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(B|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&D.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(v){v.setRenderer(this),N=v},this.dispose=function(){t.removeEventListener("webglcontextlost",rt,!1),t.removeEventListener("webglcontextrestored",et,!1),t.removeEventListener("webglcontextcreationerror",$t,!1),De.dispose(),de.dispose(),ce.dispose(),k.dispose(),ie.dispose(),$.dispose(),me.dispose(),j.dispose(),le.dispose(),xe.dispose(),xe.removeEventListener("sessionstart",Ha),xe.removeEventListener("sessionend",Wa),Nn.stop()};function rt(v){v.preventDefault(),ro("WebGLRenderer: Context Lost."),C=!0}function et(){ro("WebGLRenderer: Context Restored."),C=!1;const v=F.autoReset,U=Ae.enabled,V=Ae.autoUpdate,B=Ae.needsUpdate,z=Ae.type;Me(),F.autoReset=v,Ae.enabled=U,Ae.autoUpdate=V,Ae.needsUpdate=B,Ae.type=z}function $t(v){He("WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function Jt(v){const U=v.target;U.removeEventListener("dispose",Jt),Kl(U)}function Kl(v){Zl(v),k.remove(v)}function Zl(v){const U=k.get(v).programs;U!==void 0&&(U.forEach(function(V){le.releaseProgram(V)}),v.isShaderMaterial&&le.releaseShaderCache(v))}this.renderBufferDirect=function(v,U,V,B,z,pe){U===null&&(U=yt);const _e=z.isMesh&&z.matrixWorld.determinantAffine()<0,fe=Ql(v,U,V,B,z);g.setMaterial(B,_e);let ve=V.index,Ee=1;if(B.wireframe===!0){if(ve=q.getWireframeAttribute(V),ve===void 0)return;Ee=2}const Ie=V.drawRange,Fe=V.attributes.position;let ye=Ie.start*Ee,Ke=(Ie.start+Ie.count)*Ee;pe!==null&&(ye=Math.max(ye,pe.start*Ee),Ke=Math.min(Ke,(pe.start+pe.count)*Ee)),ve!==null?(ye=Math.max(ye,0),Ke=Math.min(Ke,ve.count)):Fe!=null&&(ye=Math.max(ye,0),Ke=Math.min(Ke,Fe.count));const ct=Ke-ye;if(ct<0||ct===1/0)return;me.setup(z,B,fe,V,ve);let at,Je=re;if(ve!==null&&(at=oe.get(ve),Je=Z,Je.setIndex(at)),z.isMesh)B.wireframe===!0?(g.setLineWidth(B.wireframeLinewidth*ut()),Je.setMode(D.LINES)):Je.setMode(D.TRIANGLES);else if(z.isLine){let Tt=B.linewidth;Tt===void 0&&(Tt=1),g.setLineWidth(Tt*ut()),z.isLineSegments?Je.setMode(D.LINES):z.isLineLoop?Je.setMode(D.LINE_LOOP):Je.setMode(D.LINE_STRIP)}else z.isPoints?Je.setMode(D.POINTS):z.isSprite&&Je.setMode(D.TRIANGLES);if(z.isBatchedMesh)if(qe.get("WEBGL_multi_draw"))Je.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Tt=z._multiDrawStarts,ge=z._multiDrawCounts,Nt=z._multiDrawCount,Ve=ve?oe.get(ve).bytesPerElement:1,zt=k.get(B).currentProgram.getUniforms();for(let Qt=0;Qt<Nt;Qt++)zt.setValue(D,"_gl_DrawID",Qt),Je.render(Tt[Qt]/Ve,ge[Qt])}else if(z.isInstancedMesh)Je.renderInstances(ye,ct,z.count);else if(V.isInstancedBufferGeometry){const Tt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,ge=Math.min(V.instanceCount,Tt);Je.renderInstances(ye,ct,ge)}else Je.render(ye,ct)};function Va(v,U,V){v.transparent===!0&&v.side===pn&&v.forceSinglePass===!1?(v.side=Ut,v.needsUpdate=!0,Hi(v,U,V),v.side=Dn,v.needsUpdate=!0,Hi(v,U,V),v.side=pn):Hi(v,U,V)}this.compile=function(v,U,V=null){V===null&&(V=v),b=ce.get(V),b.init(U),x.push(b),V.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),v!==V&&v.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();const B=new Set;return v.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const pe=z.material;if(pe)if(Array.isArray(pe))for(let _e=0;_e<pe.length;_e++){const fe=pe[_e];Va(fe,V,z),B.add(fe)}else Va(pe,V,z),B.add(pe)}),b=x.pop(),B},this.compileAsync=function(v,U,V=null){const B=this.compile(v,U,V);return new Promise(z=>{function pe(){if(B.forEach(function(_e){k.get(_e).currentProgram.isReady()&&B.delete(_e)}),B.size===0){z(v);return}setTimeout(pe,10)}qe.get("KHR_parallel_shader_compile")!==null?pe():setTimeout(pe,10)})};let Vs=null;function $l(v){Vs&&Vs(v)}function Ha(){Nn.stop()}function Wa(){Nn.start()}const Nn=new Bl;Nn.setAnimationLoop($l),typeof self<"u"&&Nn.setContext(self),this.setAnimationLoop=function(v){Vs=v,xe.setAnimationLoop(v),v===null?Nn.stop():Nn.start()},xe.addEventListener("sessionstart",Ha),xe.addEventListener("sessionend",Wa),this.render=function(v,U){if(U!==void 0&&U.isCamera!==!0){He("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;N!==null&&N.renderStart(v,U);const V=xe.enabled===!0&&xe.isPresenting===!0,B=E!==null&&(Q===null||V)&&E.begin(P,Q);if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),xe.enabled===!0&&xe.isPresenting===!0&&(E===null||E.isCompositing()===!1)&&(xe.cameraAutoUpdate===!0&&xe.updateCamera(U),U=xe.getCamera()),v.isScene===!0&&v.onBeforeRender(P,v,U,Q),b=ce.get(v,x.length),b.init(U),b.state.textureUnits=W.getTextureUnits(),x.push(b),dt.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),$e.setFromProjectionMatrix(dt,sn,U.reversedDepth),ke=this.localClippingEnabled,Xe=be.init(this.clippingPlanes,ke),A=de.get(v,w.length),A.init(),w.push(A),xe.enabled===!0&&xe.isPresenting===!0){const _e=P.xr.getDepthSensingMesh();_e!==null&&Hs(_e,U,-1/0,P.sortObjects)}Hs(v,U,0,P.sortObjects),A.finish(),P.sortObjects===!0&&A.sort(Ce,Le,U.reversedDepth),st=xe.enabled===!1||xe.isPresenting===!1||xe.hasDepthSensing()===!1,st&&De.addToRenderList(A,v),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Xe===!0&&be.beginShadows();const z=b.state.shadowsArray;if(Ae.render(z,v,U),Xe===!0&&be.endShadows(),(B&&E.hasRenderPass())===!1){const _e=A.opaque,fe=A.transmissive;if(b.setupLights(),U.isArrayCamera){const ve=U.cameras;if(fe.length>0)for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Fe=ve[Ee];qa(_e,fe,v,Fe)}st&&De.render(v);for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Fe=ve[Ee];Xa(A,v,Fe,Fe.viewport)}}else fe.length>0&&qa(_e,fe,v,U),st&&De.render(v),Xa(A,v,U)}Q!==null&&G===0&&(W.updateMultisampleRenderTarget(Q),W.updateRenderTargetMipmap(Q)),B&&E.end(P),v.isScene===!0&&v.onAfterRender(P,v,U),me.resetDefaultState(),ee=-1,se=null,x.pop(),x.length>0?(b=x[x.length-1],W.setTextureUnits(b.state.textureUnits),Xe===!0&&be.setGlobalState(P.clippingPlanes,b.state.camera)):b=null,w.pop(),w.length>0?A=w[w.length-1]:A=null,N!==null&&N.renderEnd()};function Hs(v,U,V,B){if(v.visible===!1)return;if(v.layers.test(U.layers)){if(v.isGroup)V=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(U);else if(v.isLightProbeGrid)b.pushLightProbeGrid(v);else if(v.isLight)b.pushLight(v),v.castShadow&&b.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||$e.intersectsSprite(v)){B&&St.setFromMatrixPosition(v.matrixWorld).applyMatrix4(dt);const _e=$.update(v),fe=v.material;fe.visible&&A.push(v,_e,fe,V,St.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||$e.intersectsObject(v))){const _e=$.update(v),fe=v.material;if(B&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),St.copy(v.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),St.copy(_e.boundingSphere.center)),St.applyMatrix4(v.matrixWorld).applyMatrix4(dt)),Array.isArray(fe)){const ve=_e.groups;for(let Ee=0,Ie=ve.length;Ee<Ie;Ee++){const Fe=ve[Ee],ye=fe[Fe.materialIndex];ye&&ye.visible&&A.push(v,_e,ye,V,St.z,Fe)}}else fe.visible&&A.push(v,_e,fe,V,St.z,null)}}const pe=v.children;for(let _e=0,fe=pe.length;_e<fe;_e++)Hs(pe[_e],U,V,B)}function Xa(v,U,V,B){const{opaque:z,transmissive:pe,transparent:_e}=v;b.setupLightsView(V),Xe===!0&&be.setGlobalState(P.clippingPlanes,V),B&&g.viewport(K.copy(B)),z.length>0&&Vi(z,U,V),pe.length>0&&Vi(pe,U,V),_e.length>0&&Vi(_e,U,V),g.buffers.depth.setTest(!0),g.buffers.depth.setMask(!0),g.buffers.color.setMask(!0),g.setPolygonOffset(!1)}function qa(v,U,V,B){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[B.id]===void 0){const ye=qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[B.id]=new an(1,1,{generateMipmaps:!0,type:ye?xn:Bt,minFilter:Vn,samples:Math.max(4,y.samples),stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ze.workingColorSpace})}const pe=b.state.transmissionRenderTarget[B.id],_e=B.viewport||K;pe.setSize(_e.z*P.transmissionResolutionScale,_e.w*P.transmissionResolutionScale);const fe=P.getRenderTarget(),ve=P.getActiveCubeFace(),Ee=P.getActiveMipmapLevel();P.setRenderTarget(pe),P.getClearColor(je),We=P.getClearAlpha(),We<1&&P.setClearColor(16777215,.5),P.clear(),st&&De.render(V);const Ie=P.toneMapping;P.toneMapping=rn;const Fe=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),b.setupLightsView(B),Xe===!0&&be.setGlobalState(P.clippingPlanes,B),Vi(v,V,B),W.updateMultisampleRenderTarget(pe),W.updateRenderTargetMipmap(pe),qe.has("WEBGL_multisampled_render_to_texture")===!1){let ye=!1;for(let Ke=0,ct=U.length;Ke<ct;Ke++){const at=U[Ke],{object:Je,geometry:Tt,material:ge,group:Nt}=at;if(ge.side===pn&&Je.layers.test(B.layers)){const Ve=ge.side;ge.side=Ut,ge.needsUpdate=!0,Ya(Je,V,B,Tt,ge,Nt),ge.side=Ve,ge.needsUpdate=!0,ye=!0}}ye===!0&&(W.updateMultisampleRenderTarget(pe),W.updateRenderTargetMipmap(pe))}P.setRenderTarget(fe,ve,Ee),P.setClearColor(je,We),Fe!==void 0&&(B.viewport=Fe),P.toneMapping=Ie}function Vi(v,U,V){const B=U.isScene===!0?U.overrideMaterial:null;for(let z=0,pe=v.length;z<pe;z++){const _e=v[z],{object:fe,geometry:ve,group:Ee}=_e;let Ie=_e.material;Ie.allowOverride===!0&&B!==null&&(Ie=B),fe.layers.test(V.layers)&&Ya(fe,U,V,ve,Ie,Ee)}}function Ya(v,U,V,B,z,pe){v.onBeforeRender(P,U,V,B,z,pe),v.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),z.onBeforeRender(P,U,V,B,v,pe),z.transparent===!0&&z.side===pn&&z.forceSinglePass===!1?(z.side=Ut,z.needsUpdate=!0,P.renderBufferDirect(V,U,B,z,v,pe),z.side=Dn,z.needsUpdate=!0,P.renderBufferDirect(V,U,B,z,v,pe),z.side=pn):P.renderBufferDirect(V,U,B,z,v,pe),v.onAfterRender(P,U,V,B,z,pe)}function Hi(v,U,V){U.isScene!==!0&&(U=yt);const B=k.get(v),z=b.state.lights,pe=b.state.shadowsArray,_e=z.state.version,fe=le.getParameters(v,z.state,pe,U,V,b.state.lightProbeGridArray),ve=le.getProgramCacheKey(fe);let Ee=B.programs;B.environment=v.isMeshStandardMaterial||v.isMeshLambertMaterial||v.isMeshPhongMaterial?U.environment:null,B.fog=U.fog;const Ie=v.isMeshStandardMaterial||v.isMeshLambertMaterial&&!v.envMap||v.isMeshPhongMaterial&&!v.envMap;B.envMap=ie.get(v.envMap||B.environment,Ie),B.envMapRotation=B.environment!==null&&v.envMap===null?U.environmentRotation:v.envMapRotation,Ee===void 0&&(v.addEventListener("dispose",Jt),Ee=new Map,B.programs=Ee);let Fe=Ee.get(ve);if(Fe!==void 0){if(B.currentProgram===Fe&&B.lightsStateVersion===_e)return Za(v,fe),Fe}else fe.uniforms=le.getUniforms(v),N!==null&&v.isNodeMaterial&&N.build(v,V,fe),v.onBeforeCompile(fe,P),Fe=le.acquireProgram(fe,ve),Ee.set(ve,Fe),B.uniforms=fe.uniforms;const ye=B.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(ye.clippingPlanes=be.uniform),Za(v,fe),B.needsLights=ec(v),B.lightsStateVersion=_e,B.needsLights&&(ye.ambientLightColor.value=z.state.ambient,ye.lightProbe.value=z.state.probe,ye.directionalLights.value=z.state.directional,ye.directionalLightShadows.value=z.state.directionalShadow,ye.spotLights.value=z.state.spot,ye.spotLightShadows.value=z.state.spotShadow,ye.rectAreaLights.value=z.state.rectArea,ye.ltc_1.value=z.state.rectAreaLTC1,ye.ltc_2.value=z.state.rectAreaLTC2,ye.pointLights.value=z.state.point,ye.pointLightShadows.value=z.state.pointShadow,ye.hemisphereLights.value=z.state.hemi,ye.directionalShadowMatrix.value=z.state.directionalShadowMatrix,ye.spotLightMatrix.value=z.state.spotLightMatrix,ye.spotLightMap.value=z.state.spotLightMap,ye.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=b.state.lightProbeGridArray.length>0,B.currentProgram=Fe,B.uniformsList=null,Fe}function Ka(v){if(v.uniformsList===null){const U=v.currentProgram.getUniforms();v.uniformsList=Rs.seqWithValue(U.seq,v.uniforms)}return v.uniformsList}function Za(v,U){const V=k.get(v);V.outputColorSpace=U.outputColorSpace,V.batching=U.batching,V.batchingColor=U.batchingColor,V.instancing=U.instancing,V.instancingColor=U.instancingColor,V.instancingMorph=U.instancingMorph,V.skinning=U.skinning,V.morphTargets=U.morphTargets,V.morphNormals=U.morphNormals,V.morphColors=U.morphColors,V.morphTargetsCount=U.morphTargetsCount,V.numClippingPlanes=U.numClippingPlanes,V.numIntersection=U.numClipIntersection,V.vertexAlphas=U.vertexAlphas,V.vertexTangents=U.vertexTangents,V.toneMapping=U.toneMapping}function Jl(v,U){if(v.length===0)return null;if(v.length===1)return v[0].texture!==null?v[0]:null;S.setFromMatrixPosition(U.matrixWorld);for(let V=0,B=v.length;V<B;V++){const z=v[V];if(z.texture!==null&&z.boundingBox.containsPoint(S))return z}return null}function Ql(v,U,V,B,z){U.isScene!==!0&&(U=yt),W.resetTextureUnits();const pe=U.fog,_e=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?U.environment:null,fe=Q===null?P.outputColorSpace:Q.isXRRenderTarget===!0?Q.texture.colorSpace:ze.workingColorSpace,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Ee=ie.get(B.envMap||_e,ve),Ie=B.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Fe=!!V.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),ye=!!V.morphAttributes.position,Ke=!!V.morphAttributes.normal,ct=!!V.morphAttributes.color;let at=rn;B.toneMapped&&(Q===null||Q.isXRRenderTarget===!0)&&(at=P.toneMapping);const Je=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Tt=Je!==void 0?Je.length:0,ge=k.get(B),Nt=b.state.lights;if(Xe===!0&&(ke===!0||v!==se)){const tt=v===se&&B.id===ee;be.setState(B,v,tt)}let Ve=!1;B.version===ge.__version?(ge.needsLights&&ge.lightsStateVersion!==Nt.state.version||ge.outputColorSpace!==fe||z.isBatchedMesh&&ge.batching===!1||!z.isBatchedMesh&&ge.batching===!0||z.isBatchedMesh&&ge.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&ge.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&ge.instancing===!1||!z.isInstancedMesh&&ge.instancing===!0||z.isSkinnedMesh&&ge.skinning===!1||!z.isSkinnedMesh&&ge.skinning===!0||z.isInstancedMesh&&ge.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&ge.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&ge.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&ge.instancingMorph===!1&&z.morphTexture!==null||ge.envMap!==Ee||B.fog===!0&&ge.fog!==pe||ge.numClippingPlanes!==void 0&&(ge.numClippingPlanes!==be.numPlanes||ge.numIntersection!==be.numIntersection)||ge.vertexAlphas!==Ie||ge.vertexTangents!==Fe||ge.morphTargets!==ye||ge.morphNormals!==Ke||ge.morphColors!==ct||ge.toneMapping!==at||ge.morphTargetsCount!==Tt||!!ge.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(Ve=!0):(Ve=!0,ge.__version=B.version);let zt=ge.currentProgram;Ve===!0&&(zt=Hi(B,U,z),N&&B.isNodeMaterial&&N.onUpdateProgram(B,zt,ge));let Qt=!1,Mn=!1,Kn=!1;const Qe=zt.getUniforms(),ht=ge.uniforms;if(g.useProgram(zt.program)&&(Qt=!0,Mn=!0,Kn=!0),B.id!==ee&&(ee=B.id,Mn=!0),ge.needsLights){const tt=Jl(b.state.lightProbeGridArray,z);ge.lightProbeGrid!==tt&&(ge.lightProbeGrid=tt,Mn=!0)}if(Qt||se!==v){g.buffers.depth.getReversed()&&v.reversedDepth!==!0&&(v._reversedDepth=!0,v.updateProjectionMatrix()),Qe.setValue(D,"projectionMatrix",v.projectionMatrix),Qe.setValue(D,"viewMatrix",v.matrixWorldInverse);const En=Qe.map.cameraPosition;En!==void 0&&En.setValue(D,mt.setFromMatrixPosition(v.matrixWorld)),y.logarithmicDepthBuffer&&Qe.setValue(D,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&Qe.setValue(D,"isOrthographic",v.isOrthographicCamera===!0),se!==v&&(se=v,Mn=!0,Kn=!0)}if(ge.needsLights&&(Nt.state.directionalShadowMap.length>0&&Qe.setValue(D,"directionalShadowMap",Nt.state.directionalShadowMap,W),Nt.state.spotShadowMap.length>0&&Qe.setValue(D,"spotShadowMap",Nt.state.spotShadowMap,W),Nt.state.pointShadowMap.length>0&&Qe.setValue(D,"pointShadowMap",Nt.state.pointShadowMap,W)),z.isSkinnedMesh){Qe.setOptional(D,z,"bindMatrix"),Qe.setOptional(D,z,"bindMatrixInverse");const tt=z.skeleton;tt&&(tt.boneTexture===null&&tt.computeBoneTexture(),Qe.setValue(D,"boneTexture",tt.boneTexture,W))}z.isBatchedMesh&&(Qe.setOptional(D,z,"batchingTexture"),Qe.setValue(D,"batchingTexture",z._matricesTexture,W),Qe.setOptional(D,z,"batchingIdTexture"),Qe.setValue(D,"batchingIdTexture",z._indirectTexture,W),Qe.setOptional(D,z,"batchingColorTexture"),z._colorsTexture!==null&&Qe.setValue(D,"batchingColorTexture",z._colorsTexture,W));const Sn=V.morphAttributes;if((Sn.position!==void 0||Sn.normal!==void 0||Sn.color!==void 0)&&L.update(z,V,zt),(Mn||ge.receiveShadow!==z.receiveShadow)&&(ge.receiveShadow=z.receiveShadow,Qe.setValue(D,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&U.environment!==null&&(ht.envMapIntensity.value=U.environmentIntensity),ht.dfgLUT!==void 0&&(ht.dfgLUT.value=wm()),Mn){if(Qe.setValue(D,"toneMappingExposure",P.toneMappingExposure),ge.needsLights&&jl(ht,Kn),pe&&B.fog===!0&&Se.refreshFogUniforms(ht,pe),Se.refreshMaterialUniforms(ht,B,te,ae,b.state.transmissionRenderTarget[v.id]),ge.needsLights&&ge.lightProbeGrid){const tt=ge.lightProbeGrid;ht.probesSH.value=tt.texture,ht.probesMin.value.copy(tt.boundingBox.min),ht.probesMax.value.copy(tt.boundingBox.max),ht.probesResolution.value.copy(tt.resolution)}Rs.upload(D,Ka(ge),ht,W)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Rs.upload(D,Ka(ge),ht,W),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&Qe.setValue(D,"center",z.center),Qe.setValue(D,"modelViewMatrix",z.modelViewMatrix),Qe.setValue(D,"normalMatrix",z.normalMatrix),Qe.setValue(D,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const tt=B.uniformsGroups;for(let En=0,Zn=tt.length;En<Zn;En++){const $a=tt[En];j.update($a,zt),j.bind($a,zt)}}return zt}function jl(v,U){v.ambientLightColor.needsUpdate=U,v.lightProbe.needsUpdate=U,v.directionalLights.needsUpdate=U,v.directionalLightShadows.needsUpdate=U,v.pointLights.needsUpdate=U,v.pointLightShadows.needsUpdate=U,v.spotLights.needsUpdate=U,v.spotLightShadows.needsUpdate=U,v.rectAreaLights.needsUpdate=U,v.hemisphereLights.needsUpdate=U}function ec(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return G},this.getRenderTarget=function(){return Q},this.setRenderTargetTextures=function(v,U,V){const B=k.get(v);B.__autoAllocateDepthBuffer=v.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),k.get(v.texture).__webglTexture=U,k.get(v.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:V,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(v,U){const V=k.get(v);V.__webglFramebuffer=U,V.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(v,U=0,V=0){Q=v,X=U,G=V;let B=null,z=!1,pe=!1;if(v){const fe=k.get(v);if(fe.__useDefaultFramebuffer!==void 0){g.bindFramebuffer(D.FRAMEBUFFER,fe.__webglFramebuffer),K.copy(v.viewport),ne.copy(v.scissor),Ne=v.scissorTest,g.viewport(K),g.scissor(ne),g.setScissorTest(Ne),ee=-1;return}else if(fe.__webglFramebuffer===void 0)W.setupRenderTarget(v);else if(fe.__hasExternalTextures)W.rebindTextures(v,k.get(v.texture).__webglTexture,k.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Ie=v.depthTexture;if(fe.__boundDepthTexture!==Ie){if(Ie!==null&&k.has(Ie)&&(v.width!==Ie.image.width||v.height!==Ie.image.height))throw new Error("THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.");W.setupDepthRenderbuffer(v)}}const ve=v.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(pe=!0);const Ee=k.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Ee[U])?B=Ee[U][V]:B=Ee[U],z=!0):v.samples>0&&W.useMultisampledRTT(v)===!1?B=k.get(v).__webglMultisampledFramebuffer:Array.isArray(Ee)?B=Ee[V]:B=Ee,K.copy(v.viewport),ne.copy(v.scissor),Ne=v.scissorTest}else K.copy(Te).multiplyScalar(te).floor(),ne.copy(lt).multiplyScalar(te).floor(),Ne=Be;if(V!==0&&(B=H),g.bindFramebuffer(D.FRAMEBUFFER,B)&&g.drawBuffers(v,B),g.viewport(K),g.scissor(ne),g.setScissorTest(Ne),z){const fe=k.get(v.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+U,fe.__webglTexture,V)}else if(pe){const fe=U;for(let ve=0;ve<v.textures.length;ve++){const Ee=k.get(v.textures[ve]);D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0+ve,Ee.__webglTexture,V,fe)}}else if(v!==null&&V!==0){const fe=k.get(v.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,fe.__webglTexture,V)}ee=-1},this.readRenderTargetPixels=function(v,U,V,B,z,pe,_e,fe=0){if(!(v&&v.isWebGLRenderTarget)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve){g.bindFramebuffer(D.FRAMEBUFFER,ve);try{const Ee=v.textures[fe],Ie=Ee.format,Fe=Ee.type;if(v.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+fe),!y.textureFormatReadable(Ie)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!y.textureTypeReadable(Fe)){He("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=v.width-B&&V>=0&&V<=v.height-z&&D.readPixels(U,V,B,z,he.convert(Ie),he.convert(Fe),pe)}finally{const Ee=Q!==null?k.get(Q).__webglFramebuffer:null;g.bindFramebuffer(D.FRAMEBUFFER,Ee)}}},this.readRenderTargetPixelsAsync=async function(v,U,V,B,z,pe,_e,fe=0){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=k.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve)if(U>=0&&U<=v.width-B&&V>=0&&V<=v.height-z){g.bindFramebuffer(D.FRAMEBUFFER,ve);const Ee=v.textures[fe],Ie=Ee.format,Fe=Ee.type;if(v.textures.length>1&&D.readBuffer(D.COLOR_ATTACHMENT0+fe),!y.textureFormatReadable(Ie))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!y.textureTypeReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ye=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,ye),D.bufferData(D.PIXEL_PACK_BUFFER,pe.byteLength,D.STREAM_READ),D.readPixels(U,V,B,z,he.convert(Ie),he.convert(Fe),0);const Ke=Q!==null?k.get(Q).__webglFramebuffer:null;g.bindFramebuffer(D.FRAMEBUFFER,Ke);const ct=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await Vc(D,ct,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,ye),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,pe),D.deleteBuffer(ye),D.deleteSync(ct),pe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(v,U=null,V=0){const B=Math.pow(2,-V),z=Math.floor(v.image.width*B),pe=Math.floor(v.image.height*B),_e=U!==null?U.x:0,fe=U!==null?U.y:0;W.setTexture2D(v,0),D.copyTexSubImage2D(D.TEXTURE_2D,V,0,0,_e,fe,z,pe),g.unbindTexture()},this.copyTextureToTexture=function(v,U,V=null,B=null,z=0,pe=0){let _e,fe,ve,Ee,Ie,Fe,ye,Ke,ct;const at=v.isCompressedTexture?v.mipmaps[pe]:v.image;if(V!==null)_e=V.max.x-V.min.x,fe=V.max.y-V.min.y,ve=V.isBox3?V.max.z-V.min.z:1,Ee=V.min.x,Ie=V.min.y,Fe=V.isBox3?V.min.z:0;else{const ht=Math.pow(2,-z);_e=Math.floor(at.width*ht),fe=Math.floor(at.height*ht),v.isDataArrayTexture?ve=at.depth:v.isData3DTexture?ve=Math.floor(at.depth*ht):ve=1,Ee=0,Ie=0,Fe=0}B!==null?(ye=B.x,Ke=B.y,ct=B.z):(ye=0,Ke=0,ct=0);const Je=he.convert(U.format),Tt=he.convert(U.type);let ge;U.isData3DTexture?(W.setTexture3D(U,0),ge=D.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(W.setTexture2DArray(U,0),ge=D.TEXTURE_2D_ARRAY):(W.setTexture2D(U,0),ge=D.TEXTURE_2D),g.activeTexture(D.TEXTURE0),g.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,U.flipY),g.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),g.pixelStorei(D.UNPACK_ALIGNMENT,U.unpackAlignment);const Nt=g.getParameter(D.UNPACK_ROW_LENGTH),Ve=g.getParameter(D.UNPACK_IMAGE_HEIGHT),zt=g.getParameter(D.UNPACK_SKIP_PIXELS),Qt=g.getParameter(D.UNPACK_SKIP_ROWS),Mn=g.getParameter(D.UNPACK_SKIP_IMAGES);g.pixelStorei(D.UNPACK_ROW_LENGTH,at.width),g.pixelStorei(D.UNPACK_IMAGE_HEIGHT,at.height),g.pixelStorei(D.UNPACK_SKIP_PIXELS,Ee),g.pixelStorei(D.UNPACK_SKIP_ROWS,Ie),g.pixelStorei(D.UNPACK_SKIP_IMAGES,Fe);const Kn=v.isDataArrayTexture||v.isData3DTexture,Qe=U.isDataArrayTexture||U.isData3DTexture;if(v.isDepthTexture){const ht=k.get(v),Sn=k.get(U),tt=k.get(ht.__renderTarget),En=k.get(Sn.__renderTarget);g.bindFramebuffer(D.READ_FRAMEBUFFER,tt.__webglFramebuffer),g.bindFramebuffer(D.DRAW_FRAMEBUFFER,En.__webglFramebuffer);for(let Zn=0;Zn<ve;Zn++)Kn&&(D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,k.get(v).__webglTexture,z,Fe+Zn),D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,k.get(U).__webglTexture,pe,ct+Zn)),D.blitFramebuffer(Ee,Ie,_e,fe,ye,Ke,_e,fe,D.DEPTH_BUFFER_BIT,D.NEAREST);g.bindFramebuffer(D.READ_FRAMEBUFFER,null),g.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else if(z!==0||v.isRenderTargetTexture||k.has(v)){const ht=k.get(v),Sn=k.get(U);g.bindFramebuffer(D.READ_FRAMEBUFFER,Y),g.bindFramebuffer(D.DRAW_FRAMEBUFFER,O);for(let tt=0;tt<ve;tt++)Kn?D.framebufferTextureLayer(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,ht.__webglTexture,z,Fe+tt):D.framebufferTexture2D(D.READ_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,ht.__webglTexture,z),Qe?D.framebufferTextureLayer(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,Sn.__webglTexture,pe,ct+tt):D.framebufferTexture2D(D.DRAW_FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_2D,Sn.__webglTexture,pe),z!==0?D.blitFramebuffer(Ee,Ie,_e,fe,ye,Ke,_e,fe,D.COLOR_BUFFER_BIT,D.NEAREST):Qe?D.copyTexSubImage3D(ge,pe,ye,Ke,ct+tt,Ee,Ie,_e,fe):D.copyTexSubImage2D(ge,pe,ye,Ke,Ee,Ie,_e,fe);g.bindFramebuffer(D.READ_FRAMEBUFFER,null),g.bindFramebuffer(D.DRAW_FRAMEBUFFER,null)}else Qe?v.isDataTexture||v.isData3DTexture?D.texSubImage3D(ge,pe,ye,Ke,ct,_e,fe,ve,Je,Tt,at.data):U.isCompressedArrayTexture?D.compressedTexSubImage3D(ge,pe,ye,Ke,ct,_e,fe,ve,Je,at.data):D.texSubImage3D(ge,pe,ye,Ke,ct,_e,fe,ve,Je,Tt,at):v.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,pe,ye,Ke,_e,fe,Je,Tt,at.data):v.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,pe,ye,Ke,at.width,at.height,Je,at.data):D.texSubImage2D(D.TEXTURE_2D,pe,ye,Ke,_e,fe,Je,Tt,at);g.pixelStorei(D.UNPACK_ROW_LENGTH,Nt),g.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Ve),g.pixelStorei(D.UNPACK_SKIP_PIXELS,zt),g.pixelStorei(D.UNPACK_SKIP_ROWS,Qt),g.pixelStorei(D.UNPACK_SKIP_IMAGES,Mn),pe===0&&U.generateMipmaps&&D.generateMipmap(ge),g.unbindTexture()},this.initRenderTarget=function(v){k.get(v).__webglFramebuffer===void 0&&W.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?W.setTextureCube(v,0):v.isData3DTexture?W.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?W.setTexture2DArray(v,0):W.setTexture2D(v,0),g.unbindTexture()},this.resetState=function(){X=0,G=0,Q=null,g.reset(),me.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ze._getDrawingBufferColorSpace(e),t.unpackColorSpace=ze._getUnpackColorSpace()}}const Cm=`
varying vec2 vUv;
void main() {
  vUv = uv;
  gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
