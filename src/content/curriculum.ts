...
export const MODULES: Module[] = [
  ...
  },
  {
    id: 'm5',
    icon: '🧭',
    title: { es: 'Mandelbrot como atlas', en: 'Mandelbrot as an atlas' },
    summary: {
      es: 'Del eje real al plano complejo: el isomorfismo exacto.',
      en: 'From the real axis to the complex plane: the exact isomorphism.',
    },
    lessons: [
      {
        id: 'm5-l1',
        ...
        keyPoints: {
          es: [
            'Mandelbrot: c complejo cuya órbita desde 0 no escapa.',
            'La frontera es un fractal infinitamente detallado.',
          ],
          en: [
            'Mandelbrot: complex c whose orbit from 0 does not escape.',
        ...
        blocks: {
          es: [
            ...
            },
            {
              type: 'paragraph',
              content:
                'Esta conjugación exacta significa que la dinámica del logístico y la del eje real del Mandelbrot son la misma bajo un cambio de coordenadas. El laboratorio muestra el conector r ↔ c en tiempo real.',
            },
          ],
          en: [
            {
      ...
      },
      {
        ...
        intro: {
          es: 'Cada disco del Mandelbrot es un ciclo límite cuadrático.',
          en: 'Every bulb of the Mandelbrot set is a quadratic limit cycle.',
        },
        blocks: {
          es: [
            {
              type: 'paragraph',
              content:
                'El eje real de Mandelbrot es un mapa topológico de la duplicación de periodo: el cardioide principal corresponde a puntos fijos estables (periodo 1), el disco izquierdo a periodo 2, y cada disco más pequeño a periodos cada vez mayores.',
            },
            {
              type: 'paragraph',
              content:
          ...
          en: [
            {
              type: 'paragraph',
              content:
                'The Mandelbrot real axis is a topological map of period doubling: the main cardioid corresponds to stable fixed points (period 1), the left bulb to period 2, and each smaller bulb to larger and larger periods.',
            },
            {
              type: 'paragraph',
              content:
        ...
        keyPoints: {
          es: [
            'El eje real de Mandelbrot cartografía todas las bifurcaciones cuadráticas.',
            'c = −0.75, −1.25, −1.401 y −1.75 son los hitos clave.',
          ],
          en: [
            'The Mandelbrot real axis maps all quadratic bifurcations.',
