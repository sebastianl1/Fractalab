/**
 * Curated bibliography and resources for FractaLab Sl.
...
export const RESOURCES: ResourceEntry[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    note: {
      es: 'La obra que popularizó la teoría del caos y sigue siendo la referencia fundamental para entender por qué sistemas simples producen comportamientos complejos. Cada capítulo presenta uno de los pioneros del campo (Lorenz, May, Feigenbaum, Mandelbrot, Smale) y cómo descubrieron la universalidad del caos. Es la base conceptual de todo FractaLab Sl.',
      en: 'The book that popularized chaos theory and remains the fundamental reference for understanding why simple systems produce complex behavior. Each chapter introduces one of the field\'s pioneers (Lorenz, May, Feigenbaum, Mandelbrot, Smale) and how they discovered the universality of chaos. It is the conceptual foundation of FractaLab Sl.',
    },
  ...
  },
  {
    ...
    note: {
      es: 'El artículo fundacional del mapa logístico como modelo de población que exhibe todo el espectro de dinámicas, desde puntos fijos hasta caos. La inspiración directa de FractaLab Sl.',
      en: 'The foundational paper of the logistic map as a population model exhibiting the full spectrum of dynamics, from fixed points to chaos. The direct inspiration for FractaLab Sl.',
    },
  ...
  },
  {
    ...
    note: {
      es: 'Guía visual del caos con diagramas e ilustraciones que complementan perfectamente los diagramas de FractaLab.',
      en: 'Visual guide to chaos with diagrams and illustrations that complement FractaLab\'s diagrams perfectly.',
    },
  },
  {
    id: 'r-peitgen',
  ...
  },
  {
    ...
    kind: 'tool',
    citation: {
      es: 'FractaLab Sl — Laboratorio Virtual de Dinámica No Lineal.',
      en: 'FractaLab Sl — Virtual Laboratory of Nonlinear Dynamics.',
    },
    note: {
