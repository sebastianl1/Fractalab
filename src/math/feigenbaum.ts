...
export const BIFURCATION_MILESTONES: BifurcationMilestone[] = [
  ...
  },
  {
    ...
    c: -0.75,
    description:
      'El punto fijo pierde estabilidad. La órbita oscila eternamente entre 2 valores (Periodo 2). En Mandelbrot, coincide exactamente con la frontera entre el cardioide principal y el disco izquierdo.',
  },
  {
