...
export const GUIDED_EXERCISES: GuidedExercise[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  {
    ...
    instruction:
      'Cambia al Mapa Tienda y ajusta r a 2.0. Observa el diagrama de bifurcación.',
    modelId: 'tent',
    targetR: 2.0,
    tolerance: 0.05,
  ...
  },
  {
    ...
    instruction:
      'Cambia al Mapa de Ricker y ajusta r a 20.0.',
    modelId: 'ricker',
    targetR: 20.0,
    tolerance: 0.5,
  ...
  },
  {
    ...
    instruction:
      'Cambia al Mapa Seno y busca la primera bifurcación (r ≈ 0.72).',
    modelId: 'sine',
    targetR: 0.72,
    tolerance: 0.05,
  ...
  },
  {
    ...
    description:
      'Observa la bifurcación de pitchfork en el mapa cúbico r·x(1−x²).',
    instruction:
      'Cambia al Mapa Cúbico y ajusta r a 1.0 para ver la bifurcación de pitchfork.',
    modelId: 'cubic',
    targetR: 1.0,
    tolerance: 0.1,
    ...
    options: [
      ...
      { text: 'Un punto fijo estable se bifurca en dos nuevos puntos fijos estables', correct: true },
  ...
  },
  {
    ...
    instruction:
      'Cambia al Mapa de Bernoulli y observa la secuencia generada en r = 2.0.',
    modelId: 'bernoulli',
    targetR: 2.0,
    tolerance: 0.05,
    ...
    options: [
      ...
      { text: 'Porque genera secuencias de alta entropía, aperiódicas y deterministas', correct: true },
  ...
  },
  {
    ...
    instruction:
      'Ajusta r ≈ π (3.1416) en el mapa logístico y observa el exponente de Lyapunov.',
    modelId: 'logistic',
    targetR: 3.1416,
    tolerance: 0.05,
  ...
  },
  {
    ...
    description:
      'Explora cómo diferentes escalas musicales cambian el carácter del sonido.',
    instruction:
      'Activa la sonificación en el laboratorio. Cambia entre "Pentatónica menor" y "Cromática" con el mismo parámetro r.',
    modelId: 'logistic',
    targetR: 3.2,
    tolerance: 0.1,
    question: '¿Qué diferencia fundamental hay entre la pentatónica menor y la cromática al sonificar la misma órbita?',
    options: [
      { text: 'La pentatónica suena más suave y consonante; la cromática más densa y disonante', correct: true },
  ...
  },
  {
    ...
    description:
      'Justo antes de la ventana de periodo 3, el sistema muestra intermitencia.',
    instruction:
      'Ajusta r a 3.825 en el mapa logístico y observa el comportamiento de la órbita.',
    modelId: 'logistic',
    targetR: 3.825,
    tolerance: 0.02,
    question: '¿Qué es la intermitencia?',
    options: [
      { text: 'El sistema alterna entre episodios periódicos y estallidos caóticos', correct: true },
  ...
  },
  {
    ...
    instruction:
      'Cambia al Mapa de Gauss y ajusta r a 6.0 para ver la transición.',
    modelId: 'gauss',
    targetR: 6.0,
    tolerance: 0.5,
    ...
    options: [
      ...
      { text: 'Flip (volteo): el punto fijo gana un ciclo de periodo 2 al volcarse', correct: true },
  ...
  },
  {
    ...
    description:
      'Verifica la transformación que conecta el logístico con Mandelbrot: c = (2r − r²)/4.',
    instruction:
