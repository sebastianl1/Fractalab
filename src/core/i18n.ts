...
const es: Dict = {
  ...
  'header.theory': 'Teoría & Isomorfismo',
  ...
  'banner.principles':
    '💡 Principios: 1. Caos universal en múltiples funciones. | 2. Mandelbrot es un "atlas" de bifurcaciones cuadráticas.',

  // Títulos de panel
  'panel.bifurcation': 'Diagrama de Bifurcación HD (r vs x)',
  'panel.bifurcation.sub': 'Arrastra la línea vertical para explorar el parámetro r',
  'panel.mandelbrot': 'Conjunto de Mandelbrot & Eje Real Isomórfico (c ∈ [-2.0, 0.25])',
  ...
  // Aprende
  'learn.title': 'Aprende Teoría del Caos',
  'learn.subtitle':
    'Módulos guiados con teoría, ecuaciones, demostraciones interactivas y autoevaluación.',
  ...
  'resources.subtitle':
    'Fuentes académicas y referencias para profundizar en dinámica no lineal y caos.',
};
...
const en: Dict = {
  ...
  'header.theory': 'Theory & Isomorphism',
  ...
  'banner.principles':
    '💡 Principles: 1. Universal chaos across functions. | 2. Mandelbrot is an "atlas" of quadratic bifurcations.',

  'panel.bifurcation': 'HD Bifurcation Diagram (r vs x)',
  'panel.bifurcation.sub': 'Drag the vertical line to explore parameter r',
  'panel.mandelbrot': 'Mandelbrot Set & Isomorphic Real Axis (c ∈ [-2.0, 0.25])',
  ...
  'learn.title': 'Learn Chaos Theory',
  'learn.subtitle': 'Guided modules with theory, equations, interactive demos and self-assessment.',
  ...
  'resources.subtitle':
    'Academic sources and references to go deeper into nonlinear dynamics and chaos.',
};
